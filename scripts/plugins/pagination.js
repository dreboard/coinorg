...
$.prototype.extend(
	{
		'oneSimpleTablePagination': function(userConfigurations) {
			...
			return this.each(function() {
				...
				*/
				//bootstrap friendly one below
				function createPaginationElements() {
					var paginationHTML = "";
					paginationHTML += "<div id='tablePagination' style='text-align: center; padding-top: 5px; padding-bottom: 5px;'>";
					paginationHTML += "<a id='tablePagination_firstPage' href='javascript:;' class='button left btn btn-primary' role='button'><span class='glyphicon glyphicon-fast-backward'></span></a>";
					paginationHTML += "<a id='tablePagination_prevPage' href='javascript:;' class='button right btn btn-primary' role='button''><span class='glyphicon glyphicon-chevron-left'></span></a>";
					paginationHTML += " &nbsp; Page";
					paginationHTML += "<input id='tablePagination_currPage' type='input' value='" + currPageNumber + "' size='1'>";
					paginationHTML += "of " + totalPages + "&nbsp; &nbsp; &nbsp;";
					paginationHTML += "<a id='tablePagination_nextPage' href='javascript:;' class='button left btn btn-primary' role='button''><span class='glyphicon glyphicon-chevron-right'></span></a>";
					paginationHTML += "<a id='tablePagination_lastPage' href='javascript:;' class='button right btn btn-primary' role='button''><span class='glyphicon glyphicon-fast-forward'></span></a>";
					paginationHTML += "</div>";
					return paginationHTML;
				}		  
