...
if(isset($_GET["ID"])){
	...
	$Forum->setViewNumber($questionID, $userID='1');
...
<meta name="description" content="Forum Topics" />
<meta name="keywords" content="Forum Topics" />
...
<h3><strong><a href="../login.php" class="brownLink">Sign in</a> or <a href="../registerBasic.php" class="brownLink">Join</a> to Add A Response </strong></h3>
