...
<meta name="description" content="<?php echo $coinCategory; ?> Forum Topics" />
<meta name="keywords" content="<?php echo $coinCategory; ?> Forum Topics" />
...
<title>View <?php echo $coinCategory; ?> Forum Topics</title>
...
echo '
<tr>
<td bgcolor="#FFFFFF"><a href="forumViewTopic.php?ID='.$Encryption->encode($rows['questionID']).'">'.$rows['topic'].'</a></td>
