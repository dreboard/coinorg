...
<head>
<meta name="description" content="Small cent coins certified by PCGS, ANACS and NGC.">
<meta name="keywords" content="certified Lincoln Cent, pcgs pennies, slabbed cents, slabbed coins, 3rd party graded lincoln">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Certified Small Cents</title>
...
<h1>Certified Small Cents</h1>
<p><strong>3rd party graded</strong> Lincoln, Indian Head and Flying Eagle pennies.</p>
<!--COINS LIST TABLE--> 
     
  <table width="100%" border="0" id="productTbl">
    <thead class="darker">
  <tr align="center">
    <td width="25%" align="left"><a title="Lincoln Wheat Price List" href="http://allsmallcents.com/product_list.php?coinType=Lincoln_Wheat" class="brownLinkBold">List View</a></td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>
  </tr>
...
if (isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) >= 1) {
 ...
 $IDS = mysql_real_escape_string(implode(',', $keys));
		$sql = mysql_query("SELECT * FROM products WHERE  (NOT FIND_IN_SET(productID, '$IDS')) AND siteID = '1' AND quantity >= '1' AND proGrader != 'None' ORDER BY product_name ASC");
...
<input type="image" src="img/addCartBtn.jpg" name="addCartBtn" id="addCartBtn" onclick="addCart();" />
	...
	$sql = mysql_query("SELECT * FROM products WHERE siteID = '1' AND quantity >= '1' AND proGrader != 'None' ORDER BY product_name ASC");
    if(mysql_num_rows($sql) == 0){
	  echo '
    <td width="25%">No Lincoln Wheat coins In inventory</td>
    <td width="25%">&nbsp;</td>
