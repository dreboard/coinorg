...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    ...
    <td width="3%">&nbsp;</td>
    <td width="70%" valign="top"><strong>Get Top Level Categories for eBay sites:</strong><br />
      <br />
<form id="form1" method="get" action="">
  ...
  foreach($out->CategoryArray->Category as $cat1) {
	...
	?>
   <?php echo $cat1->CategoryName;?> - <?php echo $cat1->CategoryID;?> <br>
              <?php }}?>    
  <br />
</form></td>
  </tr>
