...
//dealers
function drawMyCalendar($month, $year){
     $Event  = new Event();
	/* draw table */
	...
	for($list_day = 1; $list_day <= $days_in_month; $list_day++):
		...
		$eventStartDate = $year.'-'. str_pad($month, 2, '0', STR_PAD_LEFT).'-'. str_pad($list_day, 2, '0', STR_PAD_LEFT);
			/* add in the day number  and  QUERY THE DATABASE**/
				  $calendar.= '<div class="daynumber"><strong>'.$list_day.'</strong></div><div class="dayNumber" id="dayNumber'.$list_day.'"><ul class="eventUL">'.$Event->getEventDisplay($eventStartDate);
