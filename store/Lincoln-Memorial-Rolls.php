...
<meta name="description" content="Buy Rolls of circulated and uncirculated Lincoln Memorial pennies" />
<meta name="keywords" content="Lincoln Memorial Coins, Sets, Rolls, lincoln wheat penny rolls, wheat reverse, steel cent rollss, old copper coin rolls, The Lincoln Memorial Cent" />
<title><?php echo $coinType ?> Penny Rolls</title>
...
<h1>Lincoln Memorial Penny Rolls</h1>
...
<p>Buy <strong><a title="penny rolls" href="http://www.allsmallcents.com/Small-Cent-Rolls.php">Rolls</a></strong> of circulated and uncirculated <a title="Lincoln Wheat Penny" href="http://www.allsmallcents.com/Lincoln-Wheat-Cents.php">Lincoln Memorial</a> pennies</p>
<h2>Lincoln Memorial Coins, Sets, Rolls</h2> 
<!--COINS LIST TABLE-->      
  <table width="100%" border="0" id="productTbl">
    <thead class="darker">
  <tr align="center">
    <td width="25%" align="left"><a href="http://www.allsmallcents.com/product_list.php?coinType=Lincoln_Memorial" class="brownLinkBold">List View</a></td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>
  </tr>
...
if (isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) >= 1) {
 ...
 $IDS = mysql_real_escape_string(implode(',', $keys));
		$sql = mysql_query("SELECT * FROM products WHERE  (NOT FIND_IN_SET(productID, '$IDS')) AND siteID = '1' AND quantity >= '1' AND coinType = 'Lincoln Memorial' AND category = 'Rolls' ORDER BY product_name ASC");
		 if(mysql_num_rows($sql) == 0){
	  echo '
    <td width="25%">No Lincoln Memorial rolls In inventory</td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>
    <td width="25%">&nbsp;</td>';
} else {
	...
	$sql = mysql_query("SELECT * FROM products WHERE coinType = 'Lincoln Memorial' AND quantity >= '1' AND category = 'Rolls' AND siteID = '1' ORDER BY product_name ASC");
    if(mysql_num_rows($sql) == 0){
	  echo '
    <td width="25%">No Lincoln Memorial rolls In inventory</td>
    <td width="25%">&nbsp;</td>
...
?>
  ...
  <p>&nbsp;</p>
 <div id="ebayBanner">
 <a target="_blank" href="http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=9&pub=5575051408&toolid=10001&campid=5337343394&customid=&icep_uq=rolls&icep_sellerId=&icep_ex_kw=&icep_sortBy=12&icep_catId=31373&icep_minPrice=&icep_maxPrice=&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg"><img src="img/pennies-for-sale-on-ebay.jpg" width="554" height="100" alt="pennies-for-sale-on-ebay" /></a><img style="text-decoration:none;border:0;padding:0;margin:0;" src="http://rover.ebay.com/roverimp/1/711-53200-19255-0/1?ff3=9&pub=5575051408&toolid=10001&campid=5337343394&customid=&uq=rolls&mpt=[CACHEBUSTER]">
</div>
<p>&nbsp;</p>     
</div>
