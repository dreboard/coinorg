...
mysql_query("INSERT INTO products(product_name, quantity, price, purchasePrice, details, category, coinType, purchaseDate, proGrader, coinGrade, refund, serialNum) VALUES('$product_name', '$quantity', '$price', '$purchasePrice', '$details', '$category', '$coinType', '$purchaseDate', '$proGrader', '$coinGrade', '$refund', '$serialNum')") or die(mysql_error()); 
...
<td width="80%"><input name="product_name" type="text" id="product_name" size="80" value="<?php if(isset($_POST["product_name"])){echo $_POST["product_name"];} else { 	echo '';}?>" /></td>
</tr>
<tr>
