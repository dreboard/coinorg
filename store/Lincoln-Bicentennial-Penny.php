...
<meta name="keywords" content="Lincoln Bicentennial Coins, Rolls &amp; Sets, Lincoln Bicentennial Cents, Log Cabin penny, Formative Years penny, Professional Life penny, lincoln Presidency penny, Lincoln Birth Childhood Penny, commemorative pennies, 2009 proof set, commemorative penny, 2009 pennies" />
...
<p>The <strong>2009 pennies</strong>, four versions of <strong>Lincoln Bicentennial cents</strong> were minted, each of which has different reverse to commemorate different stages of Lincoln&rsquo;s life.</p>
...
<input type="image" src="img/addCartBtn.jpg" name="addCartBtn" id="addCartBtn" onclick="addCart();" />
	...
	$sql = mysql_query("SELECT * FROM products WHERE coinType = 'Lincoln Bicentennial' AND quantity >= '1' AND siteID = '1' ORDER BY product_name ASC");
    if(mysql_num_rows($sql) == 0){
	  echo '
    <td width="25%">No Lincoln Bicentennial coins In inventory</td>
    <td width="25%">&nbsp;</td>
