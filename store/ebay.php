...
require_once('EBay/ebay_api/Connections/conn.php'); 
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>My Comic Buddy</title>
...
require_once('EBay/ebay_api/functions/DisplayUtils.php'); 
require_once("EBay/ebay_api/functions/keep_param.php"); 
...
?>
          <img src="EBay/ebay_api/eb_img/img_rightNowSampleLogo.gif" width="128" height="83" />
      <?php } 
...
?></td>
  ...
  $timeLeft=getPrettyTimeFromEbayTime($item->sellingStatus->timeLeft);
   ...
   // $results .= "<tr><td>></td><td><a href=\"$link\">$title</a></td></tr>";?>
    ...
    <td width="5%"><?php if($pic!=""){?><a  href="EBay/ebay_api/ebay_api/eb_big_image.php?id=<?php echo  $item->itemId;?>" rel="facebox"><img src="<?php echo $pic;?>" border="0" /><br />
    ...
    <td width="45%" valign="top"><a href="<?php echo $link;?>" target="_blank"><span class="descr"><?php echo $title; ?></span>
      ...
      </a><br /> <br /><a href="EBay/ebay_api/ebay_api/eb_desription.php?id=<?php echo  $item->itemId;?>" rel="facebox"><?php echo $row_rs_settings['lang_description']; ?></a><br />
      <br />
      ...
      <?php echo $row_rs_settings['lang_pos_feedback']; ?><strong>(<?php echo $seller_feedback_perc;  ?>%)</strong><br /><?php if ($seller_top=="true"){?><img src="EBay/ebay_api/eb_img/iconTrsXSmall.gif" width="66" height="30" /><?php }?></div></td>
  ...
  ->shippingType=="Free"){?>
          ...
          <strong>
            ...
            <img src="EBay/ebay_api/ebay_api/eb_img/paypal-icon.gif" width="33" height="33" alt="PayPal" />
            <?php }?>
            </strong></td>
