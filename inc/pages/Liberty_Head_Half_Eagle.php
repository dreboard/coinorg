...
<div class="table-responsive">
  ...
  <?php   
$i = 1;
$countAll = mysql_query("SELECT DISTINCT coinVersion FROM coins WHERE coinType = '".str_replace('_', ' ', strip_tags($_GET["coinType"]))."'  ORDER BY coinYear ASC") or die(mysql_error());
