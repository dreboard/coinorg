...
$query_rs_settings = mysql_query("SELECT * FROM ebapi_settings WHERE ebapi_settings.id_sett='1'") or die(mysql_error());
$row_rs_settings = mysql_fetch_assoc($query_rs_settings);
$totalRows_rs_settings = mysql_num_rows($query_rs_settings);
?>

<?php
//error_reporting(E_ALL);  // Turn on all errors, warnings and notices for easier debugging	
	// Format of the response 
// file_require_once('functions/DisplayUtils.php'); 
...
?></td>
  ...
  $timeLeft=getPrettyTimeFromEbayTime($item->sellingStatus->timeLeft);
   ...
   // $results .= "<tr><td>></td><td><a href=\"$link\">$title</a></td></tr>";?>
    ...
    <td width="5%"><?php if($pic!=""){?><a  href="ebay_api/eb_big_image.php?id=<?php echo  $item->itemId;?>" rel="facebox"><img src="<?php echo $pic;?>" border="0" /><br />
    ...
    <td width="45%" valign="top"><a href="<?php echo $link;?>" target="_blank"><span class="descr"><?php echo $title; ?></span>
      ...
      </a><br /> <br /><a href="ebay_api/eb_desription.php?id=<?php echo  $item->itemId;?>" rel="facebox"><?php echo $row_rs_settings['lang_description']; ?></a><br />
      <br />
