...
<?php 
			$countAll = mysql_query("SELECT DISTINCT coinType FROM coins WHERE coinCategory = '$coinCategory' ORDER BY coinYear ASC") or die(mysql_error());
			  ...
			  echo '
			  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/'.$collection->getCertReportImage($coinType, $userID).'" width="50" height="50"></td>
   </tr>
     <tr class="dateHolder" valign="top">
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType='.$coinType.'">'.$coinType.'</a></td>
	 </tr>
			  ';
				  }
?>    
