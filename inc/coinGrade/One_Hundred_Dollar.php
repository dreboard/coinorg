        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Two Cent', <?php echo $collection->getNoGradeTypeCount($coinType='One_Ounce_Platinum', $userID); ?>]
            ]);
...
<table width="483" border="0" class="typeTbl" id="folderTbl">
  ...
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('One_Ounce_Platinum', $userID); ?>" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
