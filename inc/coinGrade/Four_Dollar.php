        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Twenty Cent', <?php echo $collection->getNoGradeTypeCount($coinType='Four_Dollar_Stella', $userID); ?>]
            ]);
...
<table width="483" border="0" class="typeTbl" id="folderTbl">
  ...
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Four_Dollar_Stella', $userID); ?>" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Four_Dollar_Stella">Stella</a></td>
    </tr>
 </table>
 <hr />
