        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Flying Eagle', <?php echo $collection->getNoGradeTypeCount($coinType='Flying_Eagle', $userID); ?>],
              ['Indian Head', <?php echo $collection->getNoGradeTypeCount($coinType='Indian_Head', $userID); ?>],
              ['Wheat', <?php echo $collection->getNoGradeTypeCount($coinType='Lincoln_Wheat', $userID); ?>],
              ['Memorial', <?php echo $collection->getNoGradeTypeCount($coinType='Lincoln_Memorial', $userID); ?>],
              ['Bicentennial', <?php echo $collection->getNoGradeTypeCount($coinType='Lincoln_Bicentennial', $userID); ?>],
			  ['Shield', <?php echo $collection->getNoGradeTypeCount($coinType='Union_Shield', $userID); ?>]
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  ...
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Flying_Eagle', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Indian_Head', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Lincoln_Wheat', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Lincoln_Memorial', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Lincoln_Bicentennial', $userID); ?>" alt="" width="50" height="50"></td>
  <td align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Union_Shield', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
