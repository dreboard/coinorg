    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Indian Head',  <?php echo $Invest->getTotalInvestmentByType('Indian_Head_Eagle', $userID) ?>],
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <tr>
    <td><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Indian_Head_Eagle&year=<?php echo $year ?>">Indian Head</a></strong></td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong> <a class="brownLink" href="viewTypeFinance.php?coinType=Indian_Head_Eagle&year=<?php echo $year; ?>">Indian Head</a></strong></td>
