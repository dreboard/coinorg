        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Coronet Head', <?php echo $collection->getNoGradeTypeCount($coinType='Coronet_Head_Double_Eagle', $userID); ?>],
              ['St Gaudens', <?php echo $collection->getNoGradeTypeCount($coinType='Saint_Gaudens_Double_Eagle', $userID); ?>]
            ]);
...
<table width="376" border="0" class="typeTbl" id="folderTbl">
  ...
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow">&nbsp;</td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Coronet_Head_Double_Eagle', $userID); ?>" alt="" width="50" height="50" /></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Saint_Gaudens_Double_Eagle', $userID); ?>" alt="" width="50" height="50" /></td>
  <td height="100" align="center" valign="middle" class="certBgRow">&nbsp;</td>
  </tr>
  <tr class="dateHolder" valign="top">
    <td align="center" valign="middle">&nbsp;</td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Coronet_Head_Double_Eagle">Coronet Head</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Saint_Gaudens_Double_Eagle">St Gaudens</a></td>
    <td align="center" valign="middle">&nbsp;</td>
    </tr>
 </table>
 <hr />
