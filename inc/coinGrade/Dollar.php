...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3>Silver/Clad Dollar Certified  Collection <?php echo $collection->getCertifiedCategoryCount($coinCategory, $userID) ?> of 11 (<?php echo percent($collection->getCertifiedCategoryCount($coinCategory, $userID), '11'); ?>%)</h3></td>
  </tr>
  <tr class="dateHolder" valign="top"> 
