        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Liberty Cap', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty Cap', $userID); ?>],
              ['Indian Head', <?php echo $collection->getNoGradeTypeCount($coinType='Draped_Bust_Half_Cent', $userID); ?>],
              ['Classic Head', <?php echo $collection->getNoGradeTypeCount($coinType='Classic_Head_Half_Cent', $userID); ?>],
              ['Braided Hair', <?php echo $collection->getNoGradeTypeCount($coinType='Braided_Hair_Half_Cent', $userID); ?>]
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="4"><h3><a href="viewCertCatReport.php?coinCategory=<?php echo $categoryLink ?>"><?php echo $coinCategory; ?> Certified</a> Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 4 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '4'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Half_Cent', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Draped_Bust_Half_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Classic_Head_Half_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Braided_Hair_Half_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Liberty_Cap_Half_Cent">Liberty Cap</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Draped_Bust_Half_Cent">Draped Bust</a></td>
