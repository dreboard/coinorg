        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Draped Bust', <?php echo $collection->getNoGradeTypeCount($coinType='Draped_Bust_Quarter', $userID); ?>],
              ['DC & Territories', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty_Cap_Quarter', $userID); ?>],
              ['Seated Liberty', <?php echo $collection->getNoGradeTypeCount($coinType='Seated_Liberty_Quarter', $userID); ?>],
              ['Barber', <?php echo $collection->getNoGradeTypeCount($coinType='Barber_Quarter', $userID); ?>],
              ['Standing Liberty', <?php echo $collection->getNoGradeTypeCount($coinType='Standing_Liberty', $userID); ?>],
			  ['Washington', <?php echo $collection->getNoGradeTypeCount($coinType='Washington_Quarter', $userID); ?>],
			  ['Statehood', <?php echo $collection->getNoGradeTypeCount($coinType='State_Quarter', $userID); ?>],
              ['DC & Territories', <?php echo $collection->getNoGradeTypeCount($coinType='District_of_Columbia_and_US_Territories', $userID); ?>],
              ['America', <?php echo $collection->getNoGradeTypeCount($coinType='America_the_Beautiful_Quarter', $userID); ?>],
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3><a href="viewCertCatReport.php?coinCategory=<?php echo $categoryLink ?>"><?php echo $coinCategory; ?> Certified</a> Collection <?php echo $collection->getCertifiedCategoryCount($coinCategory, $userID) ?> of 9 (<?php echo percent($collection->getCertifiedCategoryCount($coinCategory, $userID), '9'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Draped_Bust_Quarter', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Quarter', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Seated_Liberty_Quarter', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Barber_Quarter', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Standing_Liberty', $userID); ?>" alt="" width="50" height="50"></td>
  <td align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Washington_Quarter', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    ...
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Washington_Quarter">Washington</a></td>
      ...
      <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('State_Quarter', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('District_of_Columbia_and_US_Territories', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('America_the_Beautiful_Quarter', $userID); ?>" alt="" width="50" height="50"></td>
