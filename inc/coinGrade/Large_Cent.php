        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Flowing Hair', <?php echo $collection->getNoGradeTypeCount($coinType='Flowing_Hair_Large_Cent', $userID); ?>],
              ['Liberty Cap', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty_Cap_Large_Cent', $userID); ?>],
              ['Draped Bust', <?php echo $collection->getNoGradeTypeCount($coinType='Draped_Bust_Large_Cent', $userID); ?>],
              ['Classic Head', <?php echo $collection->getNoGradeTypeCount($coinType='Classic_Head_Large_Cent', $userID); ?>],
              ['Coronet Head', <?php echo $collection->getNoGradeTypeCount($coinType='Coronet_Liberty_Head_Large_Cent', $userID); ?>],
			  ['Braided Hair', <?php echo $collection->getNoGradeTypeCount($coinType='Braided_Hair_Liberty_Head_Large_Cent', $userID); ?>]
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3><a href="viewCertCatReport.php?coinCategory=<?php echo $categoryLink ?>"><?php echo $coinCategory; ?> Certified</a> Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 6 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '6'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
