        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Three Dollar', <?php echo $collection->getNoGradeTypeCount($coinType='Indian_Princess_Three_Dollar', $userID); ?>]
            ]);
...
<table width="483" border="0" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td><h3><a href="viewCertCatReport.php?coinCategory=<?php echo $categoryLink ?>"><?php echo $coinCategory; ?> Certified</a> Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 1 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '1'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Indian_Princess_Three_Dollar', $userID); ?>" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Indian_Princess_Three_Dollar">Indian Princess</a></td>
    </tr>
 </table>
 <hr />
