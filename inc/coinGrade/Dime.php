        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Drapped Bust', <?php echo $collection->getNoGradeTypeCount($coinType='Drapped_Bust_Dime', $userID); ?>],
              ['Liberty Cap', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty_Cap_Dime', $userID); ?>],
              ['Seated Liberty', <?php echo $collection->getNoGradeTypeCount($coinType='Seated_Liberty_Dime', $userID); ?>],
              ['Barber', <?php echo $collection->getNoGradeTypeCount($coinType='Barber_Dime', $userID); ?>],
              ['Mercury', <?php echo $collection->getNoGradeTypeCount($coinType='Winged_Liberty_Dime', $userID); ?>],
			  ['Roosevelt', <?php echo $collection->getNoGradeTypeCount($coinType='Roosevelt_Dime', $userID); ?>]
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  ...
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Drapped_Bust_Dime', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Seated_Liberty_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Barber_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Winged_Liberty_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Roosevelt_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Drapped_Bust_Dime">Drapped Bust</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Liberty_Cap_Dime">Liberty Cap</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Seated_Liberty_Dime"> Seated Liberty</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Barber_Dime"> Barber</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Winged_Liberty_Dime"> Mercury</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Roosevelt_Dime"> Roosevelt</a></td>
    </tr>
 </table>
 <hr />
