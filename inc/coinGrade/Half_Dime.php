        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Flowing Hair', <?php echo $collection->getNoGradeTypeCount($coinType='Flowing_Hair_Half_Dime', $userID); ?>],
              ['Draped Bust', <?php echo $collection->getNoGradeTypeCount($coinType='Draped_Bust_Half_Dime', $userID); ?>],
              ['Liberty Cap', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty_Cap_Half_Dime', $userID); ?>],
              ['Seated Liberty', <?php echo $collection->getNoGradeTypeCount($coinType='Seated_Liberty_Half_Dime', $userID); ?>]
            ]);
...
<table width="539" border="0" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3><a href="viewCertCatReport.php?coinCategory=<?php echo $categoryLink ?>"><?php echo $coinCategory; ?> Certified</a>  Collection <?php echo $collection->getCertifiedCategoryCount($coinCategory, $userID) ?> of 6 (<?php echo percent($collection->getCertifiedCategoryCount($coinCategory, $userID), '6'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Flowing_Hair_Half_Dime', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Draped_Bust_Half_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Half_Dime', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Seated_Liberty_Half_Dime', $userID); ?>" alt="" width="50" height="50"></td>
