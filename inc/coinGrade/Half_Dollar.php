        <script type="text/javascript">
          ...
          function drawChart() {
            ...
            data3.addRows([
              ['Flowing Hair', <?php echo $collection->getNoGradeTypeCount($coinType='Flowing_Hair_Half_Dollar', $userID); ?>],
              ['Draped Bust', <?php echo $collection->getNoGradeTypeCount($coinType='Draped_Bust_Half_Dollar', $userID); ?>],
              ['Liberty Cap', <?php echo $collection->getNoGradeTypeCount($coinType='Liberty_Cap_Half_Dollar', $userID); ?>],
              ['Seated Liberty', <?php echo $collection->getNoGradeTypeCount($coinType='Seated_Liberty_Dollar', $userID); ?>],
              ['Barber', <?php echo $collection->getNoGradeTypeCount($coinType='Barber_Half_Dollar', $userID); ?>],
			  ['Walking', <?php echo $collection->getNoGradeTypeCount($coinType='Walking_Liberty', $userID); ?>],
			  ['Franklin', <?php echo $collection->getNoGradeTypeCount($coinType='Franklin_Half_Dollar', $userID); ?>],
              ['Eisenhower', <?php echo $collection->getNoGradeTypeCount($coinType='Eisenhower_Dollar', $userID); ?>],
              ['Kennedy', <?php echo $collection->getNoGradeTypeCount($coinType='Kennedy_Half_Dollar', $userID); ?>],
            ]);
...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3>Half Dollar Certified Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 8 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '8'); ?>%)</h3></td>
  </tr>
  <tr class="dateHolder" valign="top"> 
    <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Flowing_Hair_Half_Dollar', $userID); ?>" width="50" height="50"></td>
    <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Draped_Bust_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
    <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
    <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Seated_Liberty_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
    <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Barber_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
    <td align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Walking_Liberty', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
  ...
  <td height="100" align="center" valign="middle">&nbsp;</td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Franklin_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Kennedy_Half_Dollar', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle">&nbsp;</td>
