<table border="0" align="center" class="typeTbl" id="folderTbl">
  ...
  <tr align="center" valign="top" class="dateHolder"> 
  <td>
  <img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Nickel Three Cent', $userID); ?>" alt="" width="100" height="100" /><br />
Nickel Three Cent </td>
  <td><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Nickel Three Cent Proof', $userID); ?>" alt="" width="100" height="100" /><br />
Nickel Three Cent Proof</td>
