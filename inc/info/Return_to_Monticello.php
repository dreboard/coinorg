<table width="372" border="0" align="center" class="typeTbl" id="folderTbl">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><?php echo $coinType ?> Type &amp; Variety Collection</h3></td>
    </tr>
  <tr align="center" valign="top" class="dateHolder"> 
  <td>
  <img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Return to Monticello', $userID); ?>" alt="" width="100" height="100" /><br />
Return to Monticello </td>
  
<td><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Return to Monticello Proof', $userID); ?>" alt="" width="100" height="100" /><br />
Proof</td>
