    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Type', 'Amount Spent'],
          ['Twenty Cent',  <?php echo $Invest->getTotalInvestmentByType('Twenty_Cent_Piece', $userID) ?>]
        ]);
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
    <td width="12%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Twenty_Cent_Piece&year=<?php echo $year ?>">Twenty Cent</a></strong></td>
    <td width="11%" align="right">$<?php echo $collection->getCoinSumByType($coinType='Twenty_Cent_Piece', $userID) ?></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">&nbsp;</td>
...
<table width="100%" border="0" id="bulkTbl">
  ...
  <tr>
    <td width="17%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Twenty_Cent_Piece&amp;year=<?php echo $year ?>">Twenty Cent Piece</a></strong></td>
    <td width="18%" align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Twenty_Cent_Piece', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Twenty_Cent_Piece', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Twenty_Cent_Piece', $userID) ?></td>
    <td width="33%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Twenty_Cent_Piece&year=<?php echo $year; ?>">Twenty Cent</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Twenty_Cent_Piece', $userID, $year) ?></strong></td>
  </tr>
  <tr>
