<table width="564" border="0" cellpadding="3" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="4" align="center"><h2><?php echo $design ?> Type Collection <?php echo $CoinDesign->getSeatedTypeCollectionProgress($userID, $design) ?> of 4 (<?php echo percent($CoinDesign->getSeatedTypeCollectionProgress($userID, $design), '4'); ?>%)</h2></td>
    </tr>
  <tr class="dateHolder" valign="top">
    <td align="center"><a href="viewListReport.php?coinType=Flowing_Hair_Large_Cent"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Flowing_Hair_Large_Cent', $userID); ?>" alt="" width="100" height="100" /></a><br />
      <a href="viewListReport.php?coinType=Flowing_Hair_Large_Cent">Large Cent</a></td> 

<td align="center"><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Flowing_Hair_Half_Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime">Half Dime</a></td>
  
<td align="center"><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Flowing_Hair_Half_Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Flowing_Hair_Half_Dollar">Half Dollar</a></td>
  
<td align="center"><a href="viewListReport.php?coinType=Flowing_Hair_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Flowing_Hair_Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Flowing_Hair_Dollar">Dollar</a></td>
...
<div>
  <table width="100%" border="1" cellpadding="3" id="masterCountTbl">
   ...
   <tr>
 <td><a href="viewListReport.php?coinType=Flowing_Hair_Large_Cent" class="brownLink"> Large Cent</a> (1793)</td>
    <td align="center"><input readonly class="rollCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Flowing_Hair_Large_Cent', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Flowing_Hair_Large_Cent', $userID)?>" /></td>
 </tr>
   <tr>
 <td><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime" class="brownLink"> Half Dime</a> (1794-1795)</td>
    <td align="center"><input readonly class="rollCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Flowing_Hair_Half_Dime', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Flowing_Hair_Half_Dime', $userID)?>" /></td>
 </tr>
  

 <tr>
  <td><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dollar" class="brownLink"> Half Dollar</a> (1794-1795)</td>
  <td align="center"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Flowing_Hair_Half_Dollar', $userID); ?>"/ ></td>  
  <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Flowing_Hair_Half_Dollar', $userID);?>" /></td>
</tr>
 
 
 <tr>
    <td><a href="viewListReport.php?coinType=Flowing_Hair_Dollar" class="brownLink"> Dollar</a> (1794-1795)</td>
     <td align="center" id="Indian_HeadCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Flowing_Hair_Dollar', $userID); ?>"/ ></td>  
     <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Flowing_Hair_Dollar', $userID)?>" /></td>
  </tr>
