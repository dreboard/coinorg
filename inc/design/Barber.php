 <table border="0" cellpadding="3" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h2><?php echo $design ?> Type Collection <?php echo $CoinDesign->getSeatedTypeCollectionProgress($userID, $design) ?> of 3 (<?php echo percent($CoinDesign->getSeatedTypeCollectionProgress($userID, $design), '3'); ?>%)</h2></td>
    </tr>
  <tr class="dateHolder" valign="top">
    <td>&nbsp;</td>
    <td><a href="viewListReport.php?coinType=Barber_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Barber Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
      <a href="viewListReport.php?coinType=Barber_Dime">Dime</a></td>
    <td><a href="viewListReport.php?coinType=Barber_Quarter"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Barber Quarter', $userID); ?>" alt="" width="100" height="100" /></a><br />
      <a href="viewListReport.php?coinType=Barber_Quarter">Quarter </a></td>
    <td><a href="viewListReport.php?coinType=Barber_Half_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Barber Half Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
      <a href="viewListReport.php?coinType=Barber_Half_Dollar">Half Dollar</a></td> 
...
<div>
  <table width="100%" border="1" cellpadding="3" id="masterCountTbl">
    <tr>
    <td width="450" class="darker">Types</td>
    <td width="247" align="center" class="darker">Collected </td>    
    <td width="267" align="center" class="darker"> Investment</td>
  </tr>
  
   <tr>
    <td><a href="viewListReport.php?coinType=Barber_Dime" class="brownLink">Barber Dime</a> (1892-1916)</td>
    <td align="center" id="Union_ShieldCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Barber Dime', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Barber Dime', $userID)?>" /></td>
 </tr>
 
   <tr>
  <td><a href="viewListReport.php?coinType=Barber_Quarter" class="brownLink">Barber Quarter</a> (1892-1916)</td>
  <td align="center"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Barber Quarter', $userID); ?>"/ ></td>  
  <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Barber Quarter', $userID);?>" /></td>
</tr>
  

 <tr>
    <td><a href="viewListReport.php?coinType=Barber_Half_Dollar" class="brownLink">Barber Half Dollar</a> (1892-1916)</td>
