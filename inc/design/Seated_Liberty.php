<table width="80%" border="0" cellpadding="3" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6" align="center"><h2><?php echo $design ?> Type Collection <?php echo $CoinDesign->getSeatedTypeCollectionProgress($userID, $design) ?> of 5 (<?php echo percent($CoinDesign->getSeatedTypeCollectionProgress($userID, $design), '5'); ?>%)</h2></td>
    </tr>
  <tr class="dateHolder" valign="top">
    <td align="center"><a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Half Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
      <a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime">Half Dime</a></td> 

<td align="center"><a href="viewListReport.php?coinType=Seated_Liberty_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Seated_Liberty_Dime">Dime</a></td>
<td align="center"><a href="viewListReport.php?coinType=Seated_Liberty_Quarter"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Quarter', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Seated_Liberty_Quarter">Quarter</a></td>
  
<td align="center"><a href="viewListReport.php?coinType=Seated_Liberty_Half_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Half Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Seated_Liberty_Half_Dollar">Half Dollar</a></td>
  
<td align="center"><a href="viewListReport.php?coinType=Seated_Liberty_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Seated_Liberty_Dollar">Dollar</a></td>  
...
<div>
  <table width="100%" border="1" cellpadding="3" id="masterCountTbl">
    <tr>
    <td width="450" class="darker">Seated Liberty Types</td>
    <td width="247" align="center" class="darker">Collected </td>    
    <td width="267" align="center" class="darker"> Investment</td>
  </tr>
  
   <tr>
 <td><a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime" class="brownLink"> Half Dime</a> (1837-1873)</td>
    <td align="center"><input readonly class="rollCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Seated Liberty Half Dime', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Seated Liberty Half Dime', $userID)?>" /></td>
 </tr>
   <tr>
 <td><a href="viewListReport.php?coinType=Seated_Liberty_Dime" class="brownLink"> Dime</a> (1837-1873)</td>
    <td align="center"><input readonly class="rollCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Seated Liberty Dime', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Seated Liberty Dime', $userID)?>" /></td>
 </tr>
  

 <tr>
  <td><a href="viewListReport.php?coinType=Seated_Liberty_Quarter" class="brownLink"> Quarter</a> (1838-1891)</td>
  <td align="center"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Seated Liberty Quarter', $userID); ?>"/ ></td>  
  <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Seated Liberty Quarter', $userID);?>" /></td>
</tr>
 
 
 <tr>
    <td><a href="viewListReport.php?coinType=Seated_Liberty_Half_Dollar" class="brownLink"> Half Dollar</a> (1839-1891)</td>
 ...
 <tr>
    <td><a href="viewListReport.php?coinType=Seated_Liberty_Dollar" class="brownLink"> Dollar</a> (1836-1873)</td>
     <td align="center" id="Indian_HeadCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Seated Liberty Dollar', $userID); ?>"/ ></td>  
     <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Seated Liberty Dollar', $userID)?>" /></td>
  </tr>
