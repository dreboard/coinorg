...
<table width="100%" border="0">
  <tr align="center">
    <td width="25%"><h3><a href="#1883P">Philly</a></h3></td>
    <td width="25%"><h3><a href="#1883S">San Fransisco</a></h3></td>
    <td width="25%"><h3><a href="#1883CC">Carson City</a></h3></td>
    <td width="25%"><h3><a href="#1883O">New Orleans</a></h3></td>    
  </tr>
</table>
<br />
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1883P">1883-P</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1883_P() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1883CC">1883-CC</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1883_CC() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1883S">1883-S</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1883_S() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1883O">1883-O</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1883_O() as $key => $value) {
	echo '
