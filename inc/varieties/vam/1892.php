...
<table width="100%" border="0">
  <tr align="center">
    <td width="25%"><h3><a href="#1892P">Philly</a></h3></td>
    <td width="25%"><h3><a href="#1892S">San Fransisco</a></h3></td>
    <td width="25%"><h3><a href="#1892CC">Carson City</a></h3></td>
    <td width="25%"><h3><a href="#1892O">New Orleans</a></h3></td>    
  </tr>
</table>
<br />
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1892P">1892-P</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1892_P() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1892CC">1892-CC</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1892_CC() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1892S">1892-S</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1892_S() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1892O">1892-O</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1892_O() as $key => $value) {
	echo '
