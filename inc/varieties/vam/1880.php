...
<table width="100%" border="0">
  <tr align="center">
    <td width="25%"><h3><a href="#1880P">Philly</a></h3></td>
    <td width="25%"><h3><a href="#1880S">San Fransisco</a></h3></td>
    <td width="25%"><h3><a href="#1880CC">Carson City</a></h3></td>
    <td width="25%"><h3><a href="#1880O">New Orleans</a></h3></td>    
  </tr>
</table>
<br />
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1880P">1880-P</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1880_P() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1880CC">1880-CC</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1880_CC() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1880S">1880-S</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1880_S() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1880O">1880-O</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1880_O() as $key => $value) {
	echo '
