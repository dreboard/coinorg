...
<table width="100%" border="0">
  <tr align="center">
    <td width="25%"><h3><a href="#1884P">Philly</a></h3></td>
    <td width="25%"><h3><a href="#1884S">San Fransisco</a></h3></td>
    <td width="25%"><h3><a href="#1884CC">Carson City</a></h3></td>
    <td width="25%"><h3><a href="#1884O">New Orleans</a></h3></td>    
  </tr>
</table>
<br />
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1884P">1884-P</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1884_P() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1884CC">1884-CC</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1884_CC() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1884S">1884-S</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1884_S() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1884O">1884-O</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1884_O() as $key => $value) {
	echo '
