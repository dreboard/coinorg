...
<table width="100%" border="0">
  <tr align="center">
    <td width="33%"><a href="#1878P">Philly</a></td>
    <td width="33%"><a href="#1878S">San Fransisco</a></td>
    <td width="33%"><a href="#1878CC">Carson City</a></td>
  </tr>
</table>

<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1878P">1878-P</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1878_P() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1878CC">1878-CC</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1878_CC() as $key => $value) {
	echo '
...
<table width="100%" border="0" align="center" class="typeTbl" id="vamTbl2" cellpadding="3">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3><a name="1878S">1878-S</a></h3></td>
  </tr>
  <tr align="center" valign="top" class="dateHolder">
<?php 
$i = 1;
foreach ($VAM->get_1878_S() as $key => $value) {
	echo '
