...
18/18(s) 59/59(n)</span></td>
  ...
  <td width="20%"><a href="viewSnowNum.php?snow=Snow_5&coinYear=<?php echo $coinYear;?>&coinType=<?php echo strip_tags($_GET["coinType"]); ?>"><img class="coinSwitch" src="../img/<?php echo $collection->getSnowByYearAndMint($coinYear, 'Snow 5', $userID, $mintMark='P', $coinType); ?>" alt="" width="100" height="100" /></a><br />
  <span>Snow 5<br />
9/9(s)</span> </td>
  </tr>
...
<td width="20%">&nbsp;</td>
  <td width="20%"><a href="viewSnowNum.php?snow=Snow_6&coinYear=<?php echo $coinYear;?>"><img class="coinSwitch" src="../img/<?php echo $collection->getSnowByYearAndMint($coinYear, 'Snow 6', $userID, $mintMark='P', $coinType); ?>" alt="" width="100" height="100" /></a><br />
  <span>Snow 6<br />
18/18(e)</span> </td>  
  <td width="20%"></td>
  <td width="20%"></td>
