...
<div id="topDiv"><div id="headerContent"><table width="100%" border="0" class="headerTbl">
  <tr>
    <td align="left"><a href="index.php"><img src="http://mycoinorganizer.com/img/logo4.jpg" alt="My Coin Organizer" name="headerLogo" width="361" height="198" align="left" id="headerLogo" /></a>
 <ul id="headerList">
 ...
 <li><span>Logged in as: <a class="brownLink" href="viewUserProfile.php"><?php echo $User->getUserName() ?></a> <?php echo $User->getCollectionAvatar($userID); ?><?php echo $User->getAnswerAvatar($userID); ?><?php echo $User->getInvestmentAvatar($userID); ?></span></li>
  <li><form id="searchForm" name="searchForm" method="post" action="search.php" class="compactForm">
...
<table width="100%" id="reportListLinks">
  <tr>
    <td class="darker">Silver / Circulated</td>
  ...
  <tr>
    <td class="darker">Platinum / Gold</td>
  ...
  <tr>
    ...
    <td class="darker"><a href="myBoxes.php">Boxes</a></td>
  </tr>
</table></div></div>