...
<tr align="center"><td colspan="4"><h3>District of Columbia and US Territories Mint Roll Collection</h3></td></tr>
  <tr class="dateHolder" valign="top"> 
<?php
$i = 1;
$result = mysql_query("SELECT * FROM rollsmint WHERE coinType = 'District of Columbia and US Territories' ORDER BY rollMintID ASC") or die(mysql_error());
