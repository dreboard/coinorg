...
<tr align="center"><td colspan="4"><h3>America the Beautiful Quarter Mint Roll Collection</h3></td></tr>
  <tr class="dateHolder" valign="top"> 
<?php
$i = 1;
$result = mysql_query("SELECT * FROM rollsmint WHERE coinType = 'America the Beautiful Quarter' ORDER BY rollMintID ASC") or die(mysql_error());
