    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Type', 'Amount Spent'],
          ['American Eagle',  <?php echo $Invest->getTotalInvestmentByType('Silver_American_Eagle', $userID) ?>]
        ]);
...
<table width="900" border="0">
  ...
  <td><img src="../img/coinIcon.jpg" width="21" height="20" align="absmiddle" /> <a class="brownLink" href="<?php echo $coinCategoryLink ?>.php"><strong>Main Report</strong></a></td>
    ...
    <td><select id="typeChanger" name="select" onchange="window.open(this.options[this.selectedIndex].value,'_top')">
      ...
      <option value="reportSpendingCategory.php?coinCategory=Twenty_Cent">American Eagle</option>
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
    <td width="12%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_American_Eagle&year=<?php echo $year ?>">American Eagle</a></strong></td>
    <td width="11%" align="right">$<?php echo $collection->getCoinSumByType($coinType='Silver_American_Eagle', $userID) ?></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">&nbsp;</td>
...
<table width="100%" border="0" id="bulkTbl">
  ...
  <tr>
    <td width="17%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_American_Eagle&amp;year=<?php echo $year ?>">American Eagle</a></strong></td>
    <td width="18%" align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Silver_American_Eagle', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Silver_American_Eagle', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Silver_American_Eagle', $userID) ?></td>
    <td width="33%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_American_Eagle&year=<?php echo $year; ?>">American Eagle</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_American_Eagle', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Silver_American_Eagle', $userID, $year) ?></strong></td>
  </tr>
  <tr>
