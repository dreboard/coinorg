    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Type', 'Amount Spent'],
          ['Coronet Head',  <?php echo $Invest->getTotalInvestmentByType('Coronet_Head_Double_Eagle', $userID) ?>],
          ['St Gaudens',  <?php echo $Invest->getTotalInvestmentByType('Saint_Gaudens_Double_Eagle', $userID) ?>]
        ]);
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
    <td width="12%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Coronet_Head_Double_Eagle&year=<?php echo $year ?>">Coronet Head</a></strong></td>
    <td width="11%" align="right">$<?php echo $collection->getCoinSumByType($coinType='Coronet_Head_Double_Eagle', $userID) ?></td>
    </tr>
  <tr>
    <td><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Saint_Gaudens_Double_Eagle&year=<?php echo $year ?>">St Gaudens</a></strong></td>
    <td align="right">$<?php echo $collection->getCoinSumByType($coinType='Saint_Gaudens_Double_Eagle', $userID) ?></td>
    </tr>
...
<table width="100%" border="0" id="bulkTbl">
  ...
  <tr>
    <td width="17%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Coronet_Head_Double_Eagle&amp;year=<?php echo $year ?>">Coronet Head</a></strong></td>
    <td width="18%" align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Coronet_Head_Double_Eagle', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Coronet_Head_Double_Eagle', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Coronet_Head_Double_Eagle', $userID) ?></td>
    <td width="33%">&nbsp;</td>
  </tr>
  <tr>
    <td><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Saint_Gaudens_Double_Eagle&amp;year=<?php echo $year ?>">St Gaudens</a></strong></td>
    <td align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Saint_Gaudens_Double_Eagle', $userID) ?></td>
    <td align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Saint_Gaudens_Double_Eagle', $userID) ?></td>
    <td align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Saint_Gaudens_Double_Eagle', $userID) ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Coronet_Head_Double_Eagle&year=<?php echo $year; ?>">Coronet Head</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Coronet_Head_Double_Eagle', $userID, $year) ?></strong></td>
  </tr>
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Saint_Gaudens_Double_Eagle&year=<?php echo $year; ?>">St Gaudens</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Saint_Gaudens_Double_Eagle', $userID, $year) ?></strong></td>
  </tr>
  <tr>
