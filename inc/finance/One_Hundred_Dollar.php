    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Type', 'Amount Spent'],
          ['1oz Platinum',  <?php echo $Invest->getTotalInvestmentByType('One_Ounce_Platinum', $userID) ?>]
        ]);
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
    <td width="12%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=One_Ounce_Platinum&year=<?php echo $year ?>">1oz Platinum</a></strong></td>
    <td width="11%" align="right">$<?php echo $collection->getCoinSumByType($coinType='One_Ounce_Platinum', $userID) ?></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right">&nbsp;</td>
...
<table width="100%" border="0" id="bulkTbl">
  ...
  <tr>
    <td width="17%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=One_Ounce_Platinum&amp;year=<?php echo $year ?>">1oz Platinum</a></strong></td>
    <td width="18%" align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='One_Ounce_Platinum', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='One_Ounce_Platinum', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='One_Ounce_Platinum', $userID) ?></td>
    <td width="33%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=One_Ounce_Platinum&year=<?php echo $year; ?>">1oz Platinum</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='One_Ounce_Platinum', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='One_Ounce_Platinum', $userID, $year) ?></strong></td>
  </tr>
  <tr>
