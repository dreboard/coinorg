    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Type', 'Amount Spent'],
          ['Silver',  <?php echo $Invest->getTotalInvestmentByType('Silver_Three_Cent', $userID) ?>],
          ['Nickel',  <?php echo $Invest->getTotalInvestmentByType('Nickel_Three_Cent', $userID) ?>]
        ]);
...
<td width="135"><strong>Total Investment</strong></td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
    <td width="12%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_Three_Cent&year=<?php echo $year ?>">Silver</a></strong></td>
    <td width="11%" align="right">$<?php echo $collection->getCoinSumByType($coinType='Silver_Three_Cent', $userID) ?></td>
    </tr>
  <tr>
    <td><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Nickel_Three_Cent&year=<?php echo $year ?>">Nickel</a></strong></td>
    <td align="right">$<?php echo $collection->getCoinSumByType($coinType='Nickel_Three_Cent', $userID) ?></td>
    </tr>
...
<table width="100%" border="0" id="bulkTbl">
  ...
  <tr>
    <td width="17%"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_Three_Cent&amp;year=<?php echo $year ?>">Silver</a></strong></td>
    <td width="18%" align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Silver_Three_Cent', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Silver_Three_Cent', $userID) ?></td>
    <td width="16%" align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Silver_Three_Cent', $userID) ?></td>
    <td width="33%">&nbsp;</td>
  </tr>
  <tr>
    <td><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Nickel_Three_Cent&amp;year=<?php echo $year ?>">Nickel</a></strong></td>
    <td align="right">$<?php echo $collectionRolls->getCoinSumByType($coinType='Nickel_Three_Cent', $userID) ?></td>
    <td align="right">$<?php echo $collectionFolder->getCoinSumByType($coinType='Nickel_Three_Cent', $userID) ?></td>
    <td align="right">$<?php echo $collectionBags->getCoinSumByType($coinType='Nickel_Three_Cent', $userID) ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" id="monthInvestTbl">
  ...
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Silver_Three_Cent&year=<?php echo $year; ?>">Silver</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Silver_Three_Cent', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Silver_Three_Cent', $userID, $year) ?></strong></td>
  </tr>
  <tr>
    <td width="200"><strong><a class="brownLink" href="viewTypeFinance.php?coinType=Nickel_Three_Cent&year=<?php echo $year; ?>">Nickel</a></strong></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='01', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='02', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='03', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='04', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='05', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='06', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='07', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='08', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='09', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='10', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='11', $year) ?></td>
    <td width="70" align="right"><?php echo $Invest->getMonthlyInvestmentByType($coinType='Nickel_Three_Cent', $userID, $month='12', $year) ?></td>
    <td width="70" align="right"><strong><?php echo $Invest->getYearInvestmentByType($coinType='Nickel_Three_Cent', $userID, $year) ?></strong></td>
  </tr>
  <tr>
