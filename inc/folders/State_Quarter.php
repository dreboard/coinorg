...
<?php $countAll = mysql_query("SELECT * FROM coins WHERE coinType = 'State Quarter' ") or die(mysql_error());
...
<?php
$i = 1;
$result = mysql_query("SELECT * FROM coins WHERE coinType = '$coinType'ORDER BY coinID ASC ".$pages->limit." ") or die(mysql_error());
