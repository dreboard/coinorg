<table border="0" align="center" class="typeTbl" id="folderTbl">
  <tr align="center" valign="top" class="dateHolder">
    <td colspan="6"><h3>Lincoln Memorial Type &amp; Variety Collection  of 3 (%)</h3></td>
    </tr>
  <tr align="center" valign="top" class="dateHolder"> 
  <td>
...
<table border="0" align="center" class="typeTbl" id="folderTbl">
  ...
  <tr align="center" valign="top" class="dateHolder"> 
  <td><a href="viewCoin.php?coinID=3881"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3881', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <span><a href="viewCoin.php?coinID=3881">1982 P Copper<br />
Large Date</a></span> 
</td>
  <td><a href="viewCoin.php?coinID=3882"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3882', $userID); ?>" alt="" width="100" height="100" /></a><br /> 
    <a href="viewCoin.php?coinID=3882">1982 P Copper<br />
Small Date</a></td>
  
<td><a href="viewCoin.php?coinID=3883"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3883', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCoin.php?coinID=3883">1982 P Zinc<br />
Large Date</a></td>
  
<td><a href="viewCoin.php?coinID=3884"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3884', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCoin.php?coinID=3884">1982 P Zinc<br />
Small Date</a></td>
  
<td><a href="viewCoin.php?coinID=3885"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3885', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCoin.php?coinID=3885">1982 D Copper<br />
Large Date</a></td>

<td><a href="viewCoin.php?coinID=3886"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3886', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <span><a href="viewCoin.php?coinID=3886">1982 D Zinc<br />
Large Date</a></span> 
</td>
  <td><a href="viewCoin.php?coinID=3887"><img class="coinSwitch" src="../img/<?php echo $collection->getShortSetImg('3887', $userID); ?>" alt="" width="100" height="100" /></a><br /> 
