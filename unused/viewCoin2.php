...
<td width="639" class="tdHeight"><span class="darker">Type: </span><a href="viewListReport.php?coinType=<?php echo $coinType ?>&amp;page=1"><?php echo $coinType ?></a></td>
<td width="12"></td>
</tr>
<tr>
...
<input type="submit" name="button" id="button" value="Submit To ICG">
</form></td>
    <td width="63%"><form class="compactForm">
    <input name="coinID" type="hidden" value="<?php echo $coinID ?>" />
<input type="submit" name="button" id="button" value="Auction This Coin">
</form></td>
    <td width="7%">&nbsp;</td>
    <td width="4%">&nbsp;</td>
  </tr>
...
<input name="name" type="hidden" value="<?php echo $coinName ?>" />  
