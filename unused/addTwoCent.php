...
<h1>Two Cent Types</h1>
<table width="100%" class="coinTypeListTbl" id="nickelTbl">
  <tr align="center">
   <td colspan="6" align="left"><h3>Two Cents</h3></td>
   </tr>
  <tr align="center">
    <td><a href="addCoinType.php?coinType=Two_Cent"><img src="../img/Two_Cent.jpg" alt="Nickel" align="absmiddle" /></a><a href="addCoinType.php?coinType=Two_Cent"><br />
      Two Cent</a><br />
(1864-1873)</td>
