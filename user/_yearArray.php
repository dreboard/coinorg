...
$coinYear = mysql_real_escape_string($_GET["coinYear"]);
  ...
  $c = 0;
	...
	$sql = mysql_query("SELECT * FROM coins WHERE coinYear = '$coinYear' ORDER BY denomination ASC") or die(mysql_error());
if(mysql_num_rows($sql) == 0){
	  echo '<p class="errorTxt">No Coins Minted in '.$coinYear.'</p>';
} else {
