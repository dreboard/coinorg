...
mysql_query("INSERT INTO unknowncoins(coinType, coinCategory, coinGrade, coinGradeNum, coinYear, problem, purchaseDate, purchaseFrom, auctionNumber, additional, purchasePrice, ebaySellerID, shopName, shopUrl, coinNote, enterDate, userID, century, denomination, viewable, coinMetal, mintMark) VALUES ('$coinType', '$coinCategory', '$coinGrade', '$coinGradeNum', '$coinYear', '$problem', '$purchaseDate', '$purchaseFrom', '$auctionNumber', '$additional', '$purchasePrice', '$ebaySellerID', '$shopName', '$shopUrl', '$coinNote', '$theDate', '$userID', '$century' , '0.005', '0', 'Copper', '$mintMark')") or die(mysql_error()); 
...
<h1><img src="../img/Half_Cent.jpg" align="absmiddle"  id="addtypeImg" />&nbsp;Add Unknown Half Cent</h1>
<div class="clear"><a href="addCoinRaw.php">Return to Coin Types</a></div>
<br />

<table width="100%" border="0">
  <tr>
    <td colspan="2" align="center"><strong><a href="addCoinType.php?coinType=Liberty_Cap_Half_Cent">Liberty Cap</a><br />
    (1793-1797)    </strong></td>
