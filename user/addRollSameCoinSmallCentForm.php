...
function getOpenCoinCounts($userID, $coinType) {
$sql = mysql_query( "SELECT * FROM collection WHERE coinType = '$coinType' AND  userID = '$userID' AND collectrollsID = '0'") or die(mysql_error()); 
...
mysql_query("INSERT INTO collectrolls(coinType, coinCategory, coinSubCategory, coinGrade, purchaseDate, purchaseFrom, auctionNumber, additional, purchasePrice, ebaySellerID, shopName, shopUrl, coinNote, enterDate, userID, rollType) VALUES('$coinType', '$coinCategory', '$coinSubCategory', '$coinGrade', '$purchaseDate', '$purchaseFrom', '$auctionNumber', '$additional', '$purchasePrice', '$ebaySellerID', '$shopName', '$shopUrl', '$coinNote', '$theDate', '$userID', 'Coin By Coin')") or die(mysql_error()); 
...
<p>Open <?php echo $coinType ?> coins in your collection <strong>(<?php echo getOpenCoinCounts($userID, $coinType) ?>)</strong></p>
<ul>
