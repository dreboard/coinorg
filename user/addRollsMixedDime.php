...
$denomination = "0.100";
$coinCount = "50";
$coinCategory = str_replace('_', ' ', 'Dime');

$coinQuery = mysql_query("SELECT * FROM coins WHERE coinCategory = 'Dime'") or die(mysql_error());
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
    <td width="182" rowspan="5" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/Mixed_Dimes.jpg" width="100" height="auto" align="texttop" /></td>
