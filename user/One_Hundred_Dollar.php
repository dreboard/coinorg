...
$coinCategory = 'One Hundred Dollar';
...
<title>My One Hundred Dollar Collection</title>
...
<h1><img src="../img/2008AEP.jpg" width="100" height="100" align="middle">My One Hundred Dollar Collection (<?php echo $collection->getCompleteCollectionCategoryById($userID, $coinCategory); ?>) Coins</h1>
...
<table width="100%" class="reportListTbl" border="0">
  ...
  <tr>
    ...
    <td><?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 1 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '6'); ?>%)</td>
  </tr>
  <tr>
...
<br />
<table width="642" border="0" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="3"><h3>One Hundred Dollar Type Collection</h3></td>
  </tr>
  <tr>
...
<div>
  <table width="100%" class="reportList priceListTbl" border="1">
    ...
    <tr>
      <td><a href="viewListReport.php?coinType=One_Ounce_Platinum">$100 One Ounce Platinum</a> (1986-Present)</td>
      <td align="center"><input readonly="readonly" class="rollCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('One_Ounce_Platinum', $userID); ?>"></td>
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('One_Ounce_Platinum', $userID)?>" /></td>
    </tr>
...
<a target="_blank" href="http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&icep_uq=100+Platinum+Eagle&icep_sellerId=&icep_ex_kw=&icep_sortBy=12&icep_catId=39482&icep_minPrice=&icep_maxPrice=&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg"><img src="../img/Platinum_on_ebay.jpg" width="900" height="100" border="0" /></a><img style="text-decoration:none;border:0;padding:0;margin:0;" src="http://rover.ebay.com/roverimp/1/711-53200-19255-0/1?ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&uq=100+Platinum+Eagle&mpt=[CACHEBUSTER]">
</p>
