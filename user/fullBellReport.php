...
<title><?php echo $coinName ?> Full Bell Lines Report</title>
...
<h2><img src="../img/<?php echo str_replace(' ', '_', $coin->getCoinVersion()); ?>.jpg" alt="11" width="100" height="100" align="absmiddle" /> <?php echo $coinName; ?>  Full Bell Lines Report</h2>
...
<table width="100%" border="0">
  <tr align="center" class="darker">
    <td colspan="2"><img src="../img/Roosevelt_Dime.jpg" alt="11" width="20" height="20" align="absmiddle" /> Full Bell Lines</td>
  ...
  <tr align="center">
    <td><?php echo $collection->getCoinDesignationProCount($userID, $fullAtt='FBL', intval($_GET['coinID'])); ?></td>
    <td><?php echo $collection->getCoinDesignationRawCount($userID, $fullAtt='FBL', intval($_GET['coinID'])); ?></td>
    <td width="12%">&nbsp;</td>
    <td width="13%">&nbsp;</td>
    </tr>
  <tr align="center">
    <td colspan="4"><a href="franklinBellReport.php?coinType=<?php echo str_replace(' ', '_', $coin->getCoinType()); ?>" class="brownLinkBold"><?php echo $coin->getCoinType(); ?>  Designation Report</a></td>
    </tr>
</table>
<hr />

<div id="redDiv">
<h3><img src="../img/Roosevelt_Dime.jpg" alt="11" width="30" height="30" align="absmiddle" /> Full Bell Lines Coins</h3>
...
<table width="395" border="0">
  <tr>
    <td colspan="2" class="darker">Highest Graded </td>
	  ...
	  <tr>
    <td><?php echo $Grade->getDesignationHighGradeNumberByCoinID($coinID, $fullAtt='FBL', $userID, $strike='Business');?></td>
    </tr>
...
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE coinID = '$coinID' AND userID = '$userID' AND fullAtt = 'FBL' ORDER BY coinGradeNum ASC") or die(mysql_error());
if(mysql_num_rows($countAll) == 0){
	  echo '
		  <tr>
		  <td width="57%"><a href="addCoinByID.php?coinID='.$coinID.'"><strong>No Coins Designated Full Bell Lines</strong></a></td>
