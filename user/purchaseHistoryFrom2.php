...
<table width="100%" border="0" id="clientTbl">
  ...
  <tbody>
<?php
$countAll = mysql_query("SELECT collection.collectionID, collectset.collectsetID FROM collection,collectset WHERE collection.purchaseFrom = '$purchaseFrom' OR collectset.purchaseFrom = '$purchaseFrom' AND collection.userID = '$userID' OR collectset.userID = '$userID'") or die(mysql_error());
