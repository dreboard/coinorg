...
<title>My 20th Century Gold Collection</title>
...
<h1><img src="../img/Mixed_Gold.jpg" width="100" height="100" align="middle" id="setTypes">My 20th Century Gold Collection</h1>
...
<table width="100%" class="reportListTbl" border="0">
  ...
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3>20th Century Gold Type Collection <?php echo $Bullion->getTypeBullionCollectionProgressByID($userID, $century) ?> of 9 (<?php echo percent($Bullion->getTypeBullionCollectionProgressByID($userID, $century), '9'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
