...
<h1><img src="../img/Three_Cent.jpg" width="100" height="100" align="middle"> Three Cents</h1>
...
<h3>Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 2 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '2'); ?>%)</h3>
  <div class="table-responsive center-block">
<table class="table coin-switch-tbl">

  <tr class="setTwoRow" valign="top"> 
<td><a href="viewListReport.php?coinType=Silver_Three_Cent"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Silver Three Cent', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Silver_Three_Cent">Silver Three Cent</a> </td>
  
<td> <a href="viewListReport.php?coinType=Nickel_Three_Cent"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Nickel Three Cent', $userID); ?>" alt="" width="100" height="100" /></a><br />
...
<table class="table table-hover clearfix">
    ...
    <tr>
  <td><a href="viewListReport.php?coinType=Silver_Three_Cent" class="brownLink">Silver Three Cent</a> (1851-1873)</td>
  <td align="center"><?php echo $collection->getReportTypeCount('Silver_Three_Cent', $userID); ?></td>  
  <td align="center"><?php echo $collection->getSumTypeCount('Silver_Three_Cent', $userID)?></td>
 </tr> 
 <tr>
    <td><a href="viewListReport.php?coinType=Nickel_Three_Cent" class="brownLink">Nickel Three Cent</a> (1865-1889)</td>
  <td align="center"><?php echo $collection->getReportTypeCount('Nickel_Three_Cent', $userID); ?></td>  
  <td align="center"><?php echo $collection->getSumTypeCount('Nickel_Three_Cent', $userID)?></td>
  </tr>
 <tr class="active darker">
   <td>Totals</td>
