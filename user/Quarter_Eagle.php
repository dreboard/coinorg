...
<title>My Quarter Eagle Collection</title>
...
<h1><img src="../img/Mixed_Quarter_Eagle.jpg" width="100" height="100" align="middle">My Quarter Eagle Collection (<?php echo $collection->getTotalCollectedCoinsByID($coinCategory, $userID); ?>) Coins</h1>
...
<table width="100%" class="reportListTbl" border="0">
  <tr>
    ...
    <td><?php echo $collection->getTotalCollectedCoinsByID($coinCategory, $userID); ?> (<?php echo $collection->getUniqueCollectionCountByCategory($userID, $coinCategory) ?> Unique)</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="49%"><strong>Type Collection Progress</strong></td>
    <td width="51%"><?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 5 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '5'); ?>%)</td>
  </tr>
  <tr>
    <td><strong>Mint Collection Progress</strong></td>
    <td><?php echo $collection->getByMintCountByCategoryByMint($userID, $coinCategory); ?> of <?php echo $Bullion->getTotalGoldCategoryMintCount($coinCategory); ?> (<?php echo percent($collection->getByMintCountByCategoryByMint($userID, $coinCategory), $Bullion->getTotalGoldCategoryMintCount($coinCategory)); ?>%)</td>
  </tr>
  <tr>
    <td><strong>Complete Collection Progress</strong></td>
    <td><?php echo $Bullion->getTotalGoldCategoryByID($userID, $coinCategory); ?> of <?php echo $collection->getCompleteCollectionCategoryCount($coinCategory); ?> (<?php echo percent($collection->getCompleteCollectionCategoryById($userID, $coinCategory), $collection->getCompleteCollectionCategoryCount($coinCategory)) ?>%)</td>
  </tr>
  </table>
  <br />
...
<table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="5"><h3>Quarter Eagle Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 5 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '5'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 

<td><a href="viewListReport.php?coinType=Liberty_Cap_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Liberty_Cap_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Liberty_Cap_Quarter_Eagle">Capped Liberty</a> </td>

<td><a href="viewListReport.php?coinType=Turban_Head_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Turban_Head_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Turban_Head_Quarter_Eagle">Turban Head</a> </td>
  
<td><a href="viewListReport.php?coinType=Liberty_Head_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Liberty_Head_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Liberty_Head_Quarter_Eagle">Liberty Head</a> </td>
  
<td><a href="viewListReport.php?coinType=Coronet_Head_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Coronet_Head_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Coronet_Head_Quarter_Eagle">Coronet Head</a> </td>  
  
<td><a href="viewListReport.php?coinType=Indian_Head_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Indian_Head_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Indian_Head_Quarter_Eagle">Indian Head</a> </td>
  

  </tr>
</table>
<br />
<table width="445" class="typeTbl">>  
  <tr class="dateHolder" valign="top">
    <td colspan="2"><h3>Quarter Eagle Commemoratives</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 

<td><a href="viewCommemorativeReport.php?coinVersion=Panama_Pacific_Exposition_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Panama_Pacific_Exposition_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCommemorativeReport.php?coinVersion=Panama_Pacific_Exposition_Quarter_Eagle" class="brownLink">Panama Pacific <br />
  Exposition</a> </td>

<td><a href="viewCommemorativeReport.php?coinVersion=Sesquicentennial_Quarter_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Sesquicentennial_Quarter_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCommemorativeReport.php?coinVersion=Sesquicentennial_Quarter_Eagle" class="brownLink">1926 American Sesquicentennial
  </a> </td>
...
<div class="roundedWhite">
  <table width="100%" class="reportList priceListTbl" border="1">
    ...
    <tr>
      <td><a href="viewListReport.php?coinType=Liberty_Cap_Quarter_Eagle" class="brownLink">Capped Liberty </a> (1796-1807)</td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Liberty_Cap_Quarter_Eagle', $userID); ?>"></td>
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Liberty_Cap_Quarter_Eagle', $userID)?>" /></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Turban_Head_Quarter_Eagle" class="brownLink">Turban Head </a> (1808-1834)</td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Turban_Head_Quarter_Eagle', $userID); ?>"></td>
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Turban_Head_Quarter_Eagle', $userID)?>" /></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Liberty_Head_Quarter_Eagle" class="brownLink">Liberty Head</a> (1834-1839) </td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Liberty Head Quarter Eagle', $userID); ?>"></td>
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Liberty Head Quarter Eagle', $userID)?>" /></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Coronet_Head_Quarter_Eagle" class="brownLink">Coronet Head</a> (1840-1907)</td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Coronet Head Quarter Eagle', $userID); ?>"></td>
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Coronet Head Quarter Eagle', $userID)?>" /></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Indian_Head_Quarter_Eagle" class="brownLink">Indian Head</a> (1908-1929)</td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Indian_Head_Quarter_Eagle', $userID); ?>"></td>
      
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Indian_Head_Quarter_Eagle', $userID)?>" /></td>
    </tr>
