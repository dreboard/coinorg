...
<title>My <?php echo $coinCategory; ?> Collections</title>
...
<h1>My <?php echo $coinCategory; ?> Collections</h1>
<p>Collections (<?php echo $CoinCollect->getCollectionCategoryCount($userID, $coinCategory) ?>) |&nbsp;
...
<?php 
$collectionQuery = mysql_query("SELECT * FROM coincollect WHERE userID = '$userID' AND coinCategory = '$coinCategory' ORDER BY coincollectName ASC") or die(mysql_error());
