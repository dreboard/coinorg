...
<h1><img src="../img/Modern_Commemorative.jpg" alt="" width="100" height="100" align="middle" /> My Commemorative Coins</h1>
<table width="100%" id="reportListLinks" class="clear">
  <tr>
     <td width="33%" class="darker"><a href="CommemorativeCoins.php?commemorativeVersion=Modern_Commemorative">Modern Commemoratives</a></td>
     <td width="33%" class="darker"><a href="CommemorativeCoins.php?commemorativeVersion=Early_Commemorative">Early Commemoratives</a></td>
    <td width="33%" class="darker"><a href="viewSets.php?setType=Commemorative" class="brownLink">Commemorative Sets</a></td> 
  </tr>
</table> 
<table width="100%" class="reportListTbl" border="0">
  <tr>
    <td width="49%"><strong>Total Collected </strong></td>
    <td width="51%"><?php echo $Commemorative->getTotalCommemorativeByID($userID); ?></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  ...
  <tr align="center">
    <td><?php echo $Commemorative->getTotalCertCommemorativeByID($userID); ?></td>
    <td><?php echo $Commemorative->getTotalProofCommemorativeByID($userID); ?></td>
    <td><?php echo $Commemorative->getTotalErrorCommemorativeByID($userID); ?></td>
    </tr>
</table>
<hr />
...
<table width="100%" border="0" id="clientTbl">
  ...
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE commemorative = '1' AND userID = '$userID' ORDER BY coinYear DESC") or die(mysql_error());
