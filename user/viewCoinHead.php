...
<table width="100%" border="0">
  <tr align="center" class="darker">
    <td colspan="2"><img src="../img/Standing_Liberty.jpg" alt="11" width="20" height="20" align="absmiddle" /> Full Head</td>
    <td width="50%"><img src="../img/Standing_Liberty.jpg" alt="11" width="20" height="20" align="absmiddle" />Unclassified</td>
    </tr>
  <tr align="center">
    <td width="26%">Slabbed</td>
    <td width="24%">Raw</td>
    <td><?php echo $collection->getCoinColorCount($userID, $color='None', intval($_GET['coinID'])); ?></td>
    </tr>
  <tr align="center">
    <td><?php echo $collection->getCoinDesignationProCount($userID, $designation='FH', intval($_GET['coinID'])); ?></td>
    <td><?php echo $collection->getCoinDesignationRawCount($userID, $designation='FH', intval($_GET['coinID'])); ?></td>
    <td>&nbsp;</td>
    </tr>
</table>
...
<div id="redDiv">
<h3><img src="../img/Standing_Liberty.jpg" alt="11" width="30" height="30" align="absmiddle" /> Full Head Coins</h3>
...
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE coinID = '$coinID' AND userID = '$userID' AND designation = 'FH' ORDER BY coinGradeNum ASC") or die(mysql_error());
if(mysql_num_rows($countAll) == 0){
	  echo '
		  <tr>
		  <td width="57%"><a href="addCoinByID.php?coinID='.$coinID.'"><strong>None Designated</strong></a></td>
