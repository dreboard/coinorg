...
<thead class="darker">
 ...
 <tbody> 
  <?php 
  	$sql = mysql_query("SELECT * FROM event WHERE MONTH(eventStartDate) = '$month' AND YEAR(eventStartDate) = '$year' AND eventType = 'Coin Show' AND userID = '$userID'") or die(mysql_error());
