...
<table width="100%" border="0">
  <tr align="center" class="darker">
    ...
    <td width="25%"><h3><a href="viewTypeRollEdit.php?ID=<?php echo $Encryption->encode($collectrollsID) ?>">Manage Roll &amp; Coins</a></h3></td>
    <td width="25%"><h3><a href="addRollType.php">New Roll</a></h3></td>
