...
<h2><img src="../img/<?php echo str_replace(' ', '_', $coin->getCoinVersion()); ?>.jpg" alt="11" width="100" height="100" align="absmiddle" /> <?php echo $coinName; ?>  Full Bands/Torch Report</h2>
...
<table width="100%" border="0">
  <tr align="center" class="darker">
    <td colspan="2"><img src="../img/Roosevelt_Dime.jpg" alt="11" width="20" height="20" align="absmiddle" /> Full Bands</td>
    <td colspan="2"><img src="../img/Roosevelt_Dime.jpg" alt="11" width="20" height="20" align="absmiddle" /> Full Torch</td>
  ...
  <tr align="center">
    ...
    <td>Slabbed</td>
    <td>Raw</td>
    <td><?php echo $collection->getCoinColorCount($userID, $fullAtt='None', intval($_GET['coinID'])); ?></td>
    </tr>
  <tr align="center">
    ...
    <td width="12%"><?php echo $collection->getCoinDesignationProCount($userID, $fullAtt='FT', intval($_GET['coinID'])); ?></td>
    <td width="13%"><?php echo $collection->getCoinDesignationRawCount($userID, $fullAtt='FT', intval($_GET['coinID'])); ?></td>
    <td>&nbsp;</td>
    </tr>
  <tr align="center">
    <td colspan="5"><a href="rooseveltBandReport.php?coinType=<?php echo str_replace(' ', '_', $coin->getCoinType()); ?>" class="brownLinkBold"><?php echo $coin->getCoinType(); ?>  Designation Report</a></td>
    </tr>
</table>
<hr />

<div id="redDiv">
<h3><img src="../img/Roosevelt_Dime.jpg" alt="11" width="30" height="30" align="absmiddle" /> Full Bands Coins</h3>
...
<hr />
<div id="redDiv">
<h3><img src="../img/Roosevelt_Dime.jpg" alt="11" width="30" height="30" align="absmiddle" /> Full Torch Coins</h3>
<table width="395" border="0">
  <tr>
    <td colspan="2" class="darker">Highest Graded </td>
    </tr>
	  <tr>
    <td><?php echo $Grade->getDesignationHighGradeNumberByCoinID($coinID, $fullAtt='RB', $userID, $strike='Business');?></td>
    </tr>
...
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE coinID = '$coinID' AND userID = '$userID' AND fullAtt = 'FT' ORDER BY coinGradeNum ASC") or die(mysql_error());
if(mysql_num_rows($countAll) == 0){
	  echo '
		  <tr>
		  <td width="57%"><a href="addCoinByID.php?coinID='.$coinID.'"><strong>No Coins Designated Full Torch</strong></a></td>
		  <td width="11%" align="center">&nbsp;</td>  
		  <td width="18%" align="center">&nbsp;</td>
		  </tr>  ';
} else {
