...
$startYear = $collectionRolls->getStartYear();
$endYear = $collectionRolls->getEndYear();
...
$availableCoinsRequest = mysql_query("SELECT * FROM collection WHERE coinCategory = '".$collectionRolls->getCoinCategory()."' AND proservice = 'None' AND collectfolderID = '0' AND collectrollsID = '0' AND collectsetID = '0' AND setregID = '0' AND coinYear BETWEEN '".$startYear."' AND '".$endYear."' AND userID = '$userID'");
...
header("location: viewDateRollEdit.php?ID=".$Encryption->encode($collectrollsID)."");
exit();
}
//roll mgt
...
<table width="909" id="viewTbl">
  <tr>    
    <td class="tdHeight"><strong>Roll Type:</strong></td>
    <td class="tdHeight"><a href="RollTypes.php?rollType=Same_Type">Same Type</a></td>
    </tr>
  <tr>
    <td width="144" class="tdHeight"><span class="darker">Coin Type: </span></td>
<td width="749" class="tdHeight"><a href="coinTypeRolls.php?coinType=<?php echo str_replace(' ', '_', $collectionRolls->getCoinType()); ?>&amp;page=1"><?php echo $collectionRolls->getCoinType(); ?></a></td>
</tr>
  <tr>
    <td><span class="darker">Type:</span></td>
    <td><?php echo $rollType ?> <?php echo $collectionRolls->getStartYear(); ?> to <?php echo $collectionRolls->getEndYear(); ?></td>
    </tr>
  <tr>
...
<tr align="center" class="darker">
    ...
    <td width="25%"><h3><a href="editRollDateRange.php?ID=<?php echo $Encryption->encode($collectrollsID) ?>">Edit This Roll Details</a></h3></td>
    <td width="25%"><h3><a href="addRollDateRange.php">Add Date Range Roll</a></h3></td>
...
<table width="100%" border="0">
  <tr>
     <td width="50%">
     <img src="../img/Lincoln_Memorialplaceholder.jpg" width="30" height="30" align="absmiddle" />  <strong><a href="viewDateRollNewCoins.php?ID=<?php echo $Encryption->encode($collectrollsID); ?>">Add New Coins To Roll: </a></strong>
      <br />
...
<?php 
$sql  = mysql_query("SELECT * FROM collection WHERE coinCategory = '".$collectionRolls->getCoinCategory()."' AND proservice = 'None' AND collectfolderID = '0' AND collectrollsID = '0' AND collectsetID = '0' AND setregID = '0' AND coinYear BETWEEN '".$startYear."' AND '".$endYear."' AND userID = '$userID'");
...
<?php
$i = 1;
$result  = mysql_query("SELECT * FROM collection WHERE coinCategory = '".$collectionRolls->getCoinCategory()."' AND proservice = 'None' AND collectfolderID = '0' AND collectrollsID = '0' AND collectsetID = '0' AND setregID = '0' AND coinYear BETWEEN '".$startYear."' AND '".$endYear."' AND userID = '$userID'");
...
<?php 
    ...
    <td>'.$collectionRolls->otherDateCoinsList(intval($row['collectionID']), $collectionRolls->getCoinCategory(), $userID, $collectrollsID).'</td>
