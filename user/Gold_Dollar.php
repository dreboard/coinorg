...
<div class="container fill-height">
 <h1><img src="../img/Gold_Dollar.jpg" width="100" height="100" align="middle">Gold Dollars</h1>
...
<h3>Gold Dollar Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 2 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '2'); ?>%)</h3>
...
<table class="table table-hover clearfix">
    ...
    <td width="228" align="center" class="darker"> Investment</td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $collection->getReportTypeCount('Liberty_Head_Gold_Dollar', $userID); ?></td>
        <td align="center"><?php echo $collection->getSumTypeCount('Liberty_Head_Gold_Dollar', $userID)?></td>
      </tr>
      <tr>
        <td><a href="viewListReport.php?coinType=Indian_Princess_Gold_Dollar" class="brownLink">Indian Head</a> (1854-1889)</td>
        <td align="center"><?php echo $collection->getReportTypeCount('Indian_Princess_Gold_Dollar', $userID); ?></td>
        <td align="center"><?php echo $collection->getSumTypeCount('Indian_Princess_Gold_Dollar', $userID)?></td>
      </tr>
      <tr class="active darker">
        <td><strong>Totals</strong></td>
        <td align="center"><?php echo $Bullion->getTotalCollectedCoinsByID($coinCategory, $userID); ?></td>
        <td align="center">$<?php echo $Bullion->getTotalInvestmentSumByCategory($coinCategory, $userID); ?></td>
      </tr>
    </table>
</div>
