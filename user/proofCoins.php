...
<h1><img src="../img/Eisenhower_Dollar_Proof.jpg" width="100" height="100" align="middle"> My <a href="proof.php" class="brownLink">Proof</a> Coins</h1>
...
<table width="100%" border="0" id="clientTbl">
  ...
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE strike = 'Proof' AND userID = '$userID'") or die(mysql_error());
if(mysql_num_rows($countAll) == 0){
	  echo '
		  <tr>
		  <td>&nbsp;</td>
		  <td>Proofs Collected</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  </tr>  ';
