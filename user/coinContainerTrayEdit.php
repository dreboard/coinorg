...
<table width="100%" border="0">
  <tr>
    <td width="25%" align="center"><h3><a href="coinContainerTray.php?ID=<?php echo $Encryption->encode($containerID) ?>">View Container</a></h3></td>    
...
<table width="100%" border="0">
  <tr>
    <td width="50%"><form action="" method="post" class="compactForm" id="removeAllCoinsForm">
      <strong><img src="../img/blank.jpg" alt="" width="30" height="30" align="absmiddle" /> Remove All Rolls From Tray: </strong>
      ...
      <br />
      <span id="removeAllCoinsSpan">*Keep Tray</span>
    </form></td>
    <td><form action="" method="post" class="compactForm" id="deleteFolderForm">
      <strong><img src="../img/noRoll.jpg" alt="" width="30" height="30" align="absmiddle" /> Delete Tray: </strong>
      <input name="ID" type="hidden" value="<?php echo $Encryption->encode($containerID); ?>" />
