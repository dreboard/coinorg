...
.controlLinks a {color:#6a5246; font-weight:bold;}
</style>
</head>
...
<tr>
  ...
  <td colspan="3"><input name="cost" type="text" id="cost" size="10" maxlength="10"></td>
  </tr>
  </table>
...
<tr>
  <td align="right"><input name="ID" type="hidden" value="<?php echo $_GET['ID']; ?>" /></td>
