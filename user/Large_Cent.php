...
<title>My Large Cent Collection</title>
...
<div class="container fill-height">
 <h1><img src="../img/Large_Cent.jpg" width="100" height="100" align="middle"> Large Cents</h1>
...
<table width="100%" border="0">
  <tr align="center">
    <td><a href="LargeCentReport.php?type=early">Early Date (1793-1814)</a></td>
    <td><a href="LargeCentReport.php?type=middle">Middle Date (1816-39)</a></td>
    <td><a href="LargeCentReport.php?type=late">Late Date (1839-57)</a></td>
  </tr>
  <tr align="center">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr align="center">
    <td colspan="3">
      ...
      <option value="">By Year Sheldon List</option>
        <?php // Generate minimum years
        foreach (range('1793', '1814') as $year) { ?>
        <option value="LargeCentSheldon.php?coinYear=<?php echo($year); ?>"><?php echo($year); ?></option>
        <?php } ?>
        </select>
    </td>
    </tr>
...
<table class="table table-hover clearfix">
    ...
    <tr class="reportList priceListTbl">
      ...
      <td align="center" id="Flowing_Hair_Large_CentCount"><?php echo $collection->getReportTypeCount('Flowing Hair Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Flowing Hair Large Cent', $userID)?></td>
    </tr>
    <tr class="reportList priceListTbl">
      <td><a href="viewListReport.php?coinType=Liberty_Cap_Large_Cent" class="brownLink">Liberty Cap</a> (1793-1796)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Liberty Cap Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Liberty Cap Large Cent', $userID)?></td>
    </tr>
    <tr class="reportList priceListTbl">
      <td><a href="viewListReport.php?coinType=Draped_Bust_Large_Cent" class="brownLink">Draped Bust</a> (1796-1807) </td>
      <td align="center"><?php echo $collection->getReportTypeCount('Draped Bust Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Draped Bust Large Cent', $userID)?></td>
    </tr>
    <tr class="reportList priceListTbl">
      <td><a href="viewListReport.php?coinType=Classic_Head_Large_Cent" class="brownLink">Classic Head</a> (1808-1814)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Classic Head Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Classic Head Large Cent', $userID)?></td>
    </tr>
    <tr class="reportList priceListTbl">
      ...
      <td align="center"><?php echo $collection->getReportTypeCount('Coronet Liberty Head Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Coronet Liberty Head Large Cent', $userID)?></td>
    </tr>
    <tr class="reportList priceListTbl">
      ...
      <td align="center"><?php echo $collection->getReportTypeCount('Braided Hair Liberty Head Large Cent', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Braided Hair Liberty Head Large Cent', $userID)?></td>
    </tr>
