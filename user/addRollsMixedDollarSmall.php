...
$coinQuery = mysql_query("SELECT * FROM coins WHERE coinCategory = 'Dollar' AND coinSize = 'Small'") or die(mysql_error());
...
<h1>Add Mixed Small <?php echo $coinCategory ?> Roll</h1>
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
   ...
   $getTypes = mysql_query("SELECT DISTINCT coinType FROM coins WHERE coinCategory = '$coinCategory' AND coinSize = 'Small' AND coinMetal = 'Clad' AND coinType != 'Commemorative'") or die(mysql_error());
