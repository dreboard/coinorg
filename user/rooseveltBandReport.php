...
<?php include("../inc/pageElements/viewTypeLinks.php"); ?>
  ...
  <table width="100%" border="0">
    <tr class="darker">
      <td width="50%"><h3>By Year  Designations</h3></td>
    <td width="25%" align="center">Full Bands</td>
    <td width="25%" align="center">Full Torch</td>
    </tr>
<?php
...
while($row = mysql_fetch_array($countAll))
     ...
     echo '
    <tr class="gryHover">
      <td><a class="brownLink" href="viewRooseveltBandReport.php?coinID='.intval($row['coinID']).'">'.$coin->getCoinName().'</a></td>
      <td align="center">'.$collection->getCoinDesignationCount($userID, $fullAtt='FB', intval($row['coinID'])).'</td>
      <td align="center">'.$collection->getCoinDesignationCount($userID, $fullAtt='FT', intval($row['coinID'])).'</td>
    </tr> 
	 ';
	  }
?>    
