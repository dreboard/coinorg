...
<title>Add <?php echo $coinType ?></title>
...
<h1>Add <?php echo $coinType ?></h1>
<table width="100%" border="0" id="rawTypeTbl">
  <tr align="center">
    <td><a href="#forms"><img src="../img/Half_Cent.jpg" alt="Half Cent" name="Half_CentImg"  class="newImg" id="Half_CentImg" /></a></td>
...
<table width="979" border="0" class="priceListTbl">
  <tr>
    ...
    <td width="118" rowspan="2" valign="top"><img src="../img/blank2.jpg" alt="Half Cent" name="Half_CentFormImg" align="left"  class="newFormImg" id="Half_CentFormImg" /></td>
    <td width="322" valign="top" id="halfCentYears">&nbsp;</td>
  </tr>
  <tr>
...
<table width="979" border="0" class="priceListTbl">
  ...
  <tr>
    ...
    <td><select id="halfCentCoinName" name="coinID">
