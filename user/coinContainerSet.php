...
<table width="100%" border="0">
  <tr>
    <td width="25%" align="center"><h3><a href="coinContainerSetEdit.php?ID=<?php echo $Encryption->encode($containerID) ?>">Manage Coins &amp; Container</a></h3></td>    
...
<hr />
<h3><a href="coinContainerSlabAlbum.php?ID=<?php echo $Encryption->encode($containerID) ?>" class="brownLink">Album View</a> | <a href="coinContainerSlabReport.php?ID=<?php echo $Encryption->encode($containerID) ?>">Report View</a></h3>
