...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td align="right"><?php echo $Container->getCertCount($containerID); ?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<h3>Album View | <a href="coinContainerList.php?ID=<?php echo $Encryption->encode($containerID) ?>">List View</a></h3>
