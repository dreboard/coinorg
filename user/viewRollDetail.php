...
<table width="100%" border="0" cellpadding="6">
  ...
  <tr>
    ...
    <td width="89%">
    <?php // echo $collectionRolls->editCoinSelects($collectrollsID, $num='1'); ?>
	<?php //echo $collectionRolls->getCoin1($coinType); ?>
    </td>
  </tr>
  <tr>
    <td>Coin 2</td>
    <td>
	<?php  //echo $collectionRolls->getCoin2(); ?>
    </td>
  </tr>
  <tr>
    <td>Coin 3</td>
    <td>
	<?php  //echo $collectionRolls->getCoin3(); ?>
    </td>
  </tr>
    <tr>
      <td>Coin 50</td>
