...
$noteID = $Encryption->decode($_POST['ID']);
$noteTitle = mysql_real_escape_string($_POST["noteTitle"]);
$note = mysql_real_escape_string($_POST["note"]);

mysql_query("UPDATE notes SET noteTitle = '$noteTitle', note = '$note' WHERE noteID = '$noteID'") or die(mysql_error()); 	
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="88%">
      <input name="noteTitle" type="text" id="noteTitle" value="<?php echo $Note->getNoteTitle(); ?>" size="70" /></td>
  </tr>
  <tr>
