...
<title>My Half Dime Collection</title>
...
<div class="container fill-height">
 <h1><img src="../img/Half_DimeMixed.jpg" width="100" height="100" align="middle"> Half Dimes</h1>
...
<td><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime">
  <img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Flowing Hair Half Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime">Flowing Hair</a> 
</td>
  <td><a href="viewListReport.php?coinType=Draped_Bust_Half_Dime">  <img class="coinSwitch" src="../img/<?php echo$collection->getReportImage('Draped Bust Half Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Draped_Bust_Half_Dime">Draped Bust</a> </td>
<td><a href="viewListReport.php?coinType=Liberty_Cap_Half_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Liberty Cap Half Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Liberty_Cap_Half_Dime">Liberty Cap</a> </td>
<td> <a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Seated Liberty Half Dime', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime">Seated Liberty</a> </td>
  </tr>
 </table>
 </div>
 <hr />
...
<table class="table table-hover clearfix">
 ...
 <tr class="active darker">
  ...
  <tr class="reportList priceListTbl">
    <td><a href="viewListReport.php?coinType=Flowing_Hair_Half_Dime" class="brownLink">Flowing Hair</a> (1794-1795)</td>
    <td align="center" id="Flowing_Hair_Half_DimeCount"><?php echo $collection->getReportTypeCount('Flowing Hair Half Dime', $userID); ?></td>
    <td align="center"><?php echo $collection->getSumTypeCount('Flowing Hair Half Dime', $userID)?></td>
  <tr class="reportList priceListTbl">
    <td><a href="viewListReport.php?coinType=Draped_Bust_Half_Dime" class="brownLink">Draped Bust Half Dime</a> (1796-1805)</td>
    <td align="center" id="Draped_Bust_Half_DimeCount"><?php echo $collection->getReportTypeCount('Draped Bust Half Dime', $userID); ?></td>
    <td align="center"><?php echo $collection->getSumTypeCount('Draped_Bust_Half_Dime', $userID)?></td>
  </tr>
  <tr class="reportList priceListTbl">
    <td><a href="viewListReport.php?coinType=Liberty_Cap_Half_Dime" class="brownLink">Liberty Cap</a> (1794-1795)
    <td align="center" id="Liberty_Cap_Half_DimeCount"><?php echo $collection->getReportTypeCount('Liberty Cap Half Dime', $userID); ?></td>
    <td align="center"><?php echo $collection->getSumTypeCount('Liberty Cap Half Dime', $userID)?></td>
  </tr>
  <tr class="reportList priceListTbl">
    <td><a href="viewListReport.php?coinType=Seated_Liberty_Half_Dime" class="brownLink">Seated Liberty</a> (1837-1873)</td>
    <td align="center" id="Lincoln_MemorialCount"><?php echo getCentTypeCount('Seated Liberty Half Dime', $userID); ?></td>
    <td align="center"><?php echo $collection->getSumTypeCount('Seated Liberty Half Dime', $userID)?></td>
  </tr>
...
<p class="hidden-xs">
<a target="_blank" href="http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&icep_uq=&icep_sellerId=&icep_ex_kw=&icep_sortBy=12&icep_catId=149928&icep_minPrice=&icep_maxPrice=&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg"><img src="../img/Half_Dime_on_ebay.jpg" width="900" height="100" border="0" /></a><img style="text-decoration:none;border:0;padding:0;margin:0;" src="http://rover.ebay.com/roverimp/1/711-53200-19255-0/1?ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&mpt=[CACHEBUSTER]"></p>
  <!--Content Below-->
