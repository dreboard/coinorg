...
<table width="100%" border="0">
  <tr>
    ...
    <td width="56%" rowspan="2"><h1><a href="<?php echo $categoryLink ?>.php"><?php echo $coinCategory ?></a> Boxes</h1>      <h3>&nbsp;</h3></td>
...
<table width="100%" border="0" cellpadding="3">
  <tbody>
    ...
    <tr>
      <td><a href="categoryRollType.php?coinCategory=<?php echo $categoryLink; ?>&rollType=Same_Coin">Single Coin</a></td>
    ...
    <tr>
      <td><a href="categoryRollType.php?coinCategory=<?php echo $categoryLink; ?>&rollType=Same_Type">By Coin Type</a></td>
    ...
    <tr>
      <td><a href="categoryRollType.php?coinCategory=<?php echo $categoryLink; ?>&rollType=Date_Range">Date Range</a></td>
...
<table width="100%" border="0" id="rollListTbl">
  <thead>
  <tr class="darker">
    <td width="63%" height="24"><strong>Box Name</strong></td>  
    <td width="17%" align="center"><strong>Coin Type</strong></td>
    <td width="20%" align="center"><strong>Bag Type</strong></td>
  </tr>
</thead>
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collectrolls WHERE userID = '$userID' AND coinCategory = '$coinCategory'") or die(mysql_error());

if(mysql_num_rows($countAll)== 0){
	  echo '
    <tr class="gryHover">
    <td><a href="addBulk.php" class="brownLinkBold">No '.$coinCategory.' Bags Collected</a></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>	    
  </tr>
  ';
