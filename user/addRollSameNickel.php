...
<table width="100%" border="0" align="center" id="rawTypeTbl">
  <tr align="center">
    ...
    <td><a href="addRollCoinCategory.php?coinType=Liberty_Head_Nickel"><img src="../img/Liberty_Head_Nickel.jpg" name="Indian_Head"  class="newImg" id="Indian_Head" /></a></td>
    <td><a href="addRollCoinCategory.php?coinType=Indian_Head_Nickel"><img src="../img/Indian_Head_Nickel.jpg" class="newImg" id="Lincoln_Wheat" /></a></td>
