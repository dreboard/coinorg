...
<table width="930" id="viewTbl">
  <tr>
    <td width="121" rowspan="6" valign="top"><a href="viewListReport.php?coinType=<?php echo $coinType ?>&amp;page=1"><img src="../img/<?php echo str_replace(' ', '_', $collectionRolls->getCoinType()) ?>.jpg" alt="11" width="100" height="100" align="absmiddle" /></a></td>
    <td class="tdHeight"><strong>Roll Type:</strong></td>
    <td class="tdHeight"><a href="RollTypes.php?rollType=Same_Year">Same Year</a></td>
    <td></td>
  </tr>
  <tr>
    <td width="195" class="tdHeight"><span class="darker">Coin Type: </span></td>
<td width="578" class="tdHeight"><a href="coinTypeRolls.php?coinType=<?php echo str_replace(' ', '_', $collectionRolls->getCoinType()); ?>&amp;page=1"><?php echo $coinType ?></a></td>
<td width="16"></td>
</tr>
<tr>
...
<table width="100%" border="0">
  <tr align="center" class="darker">
    ...
    <td width="25%"><h3><a href="viewYearRollEdit.php?ID=<?php echo $Encryption->encode($collectrollsID) ?>">Manage Roll &amp; Coins</a></h3></td>
    <td width="25%"><h3><a href="addRollSameMintDiffYrs.php">New Roll</a></h3></td>
