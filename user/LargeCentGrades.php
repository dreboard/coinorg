...
$allTypes = getSubCatCount('Large Cent');
$typeCollected = getSubVarietyCountCollected($userID, 'Large Cent');
...
<table width="100%" border="0">
  <tr>
    <td width="77%"><h1><img src="../img/Mixed_Cents.jpg" width="100" height="100" align="middle">My Large Cent Grade Report</h1></td>
...
<table width="100%" id="reportListLinks" class="clear">
 ...
 <table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3>Large Cent Certified Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 6 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '6'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Flowing_Hair_Large_Cent', $userID); ?>" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Liberty_Cap_Large_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Draped_Bust_Large_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Classic_Head_Large_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td height="100" align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Coronet_Liberty_Head_Large_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  <td align="center" valign="middle" class="certBgRow"><img src="../img/<?php echo $collection->getCertReportImage('Braided_Hair_Liberty_Head_Large_Cent', $userID); ?>" alt="" width="50" height="50"></td>
  </tr>
  <tr class="dateHolder" valign="top">
    ...
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Coronet_Liberty_Head_Large_Cent">Coronet Liberty Head</a></td>
    <td align="center" valign="middle"><a href="viewGradeReport.php?coinType=Braided_Hair_Liberty_Head_Large_Cent">Braided Hair Liberty Head</a></td>
    </tr>
 </table>
  ...
  <div class="roundedWhite">
    ...
    <table width="100%" border="0">
     ...
     <tr align="center">
       <td><a href="viewCategoryService.php?proService=PCGS&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('PCGS', 'Large Cent' ,$userID); ?></a></td>
       <td><a href="viewCategoryService.php?proService=ICG&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('ICG', 'Large Cent' ,$userID); ?></a></td>
       <td><a href="viewCategoryService.php?proService=NGC&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('NGC', 'Large Cent' ,$userID); ?></a></td>
       <td><a href="viewCategoryService.php?proService=ANACS&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('ANACS', 'Large Cent' ,$userID); ?></a></td>
       <td><a href="viewCategoryService.php?proService=SEGS&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('SEGS', 'Large Cent',$userID); ?></a></td>
      <td><a href="viewCategoryService.php?proService=PCI&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('PCI', 'v Cent',$userID); ?></a></td>
       <td><a href="viewCategoryService.php?proService=ICCS&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('ICCS','Large Cent' ,$userID); ?></a></td>
      <td><a href="viewCategoryService.php?proService=HALLMARK&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('HALLMARK', 'Large Cent' ,$userID); ?></a></td>
      <td><a href="viewCategoryService.php?proService=NTC&coinCategory=<?php echo $categoryLink; ?>"><?php echo $collection->getProGrader('NTC','Large Cent' ,$userID); ?></a></td>
     </tr>
   </table>
   <br class="clear"> 
