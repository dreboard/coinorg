...
<title>Add Raw or Slabbed Coin</title>
...
<table width="100%" class="table">
  <tr>
    <td><a role="button" class="btn btn-primary btn-block" href="addBullion.php">Add Bullion Coin</a></td>
  </tr>
  <tr>
    <td>
...
<table class="table table-hover" id="new-coin-selects-tbl">
  <tr>
    ...
    <td width="40%"><select class="form-control" onchange="window.open(this.options[this.selectedIndex].value,'_top')">
