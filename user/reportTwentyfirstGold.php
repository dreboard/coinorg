...
<title>My Small Cent Collection</title>
...
<h1><img id="setTypes" src="../img/19thTypes.jpg" align="middle">My  21st Century Gold Collection</h1>
...
<table width="100%" class="reportListTbl" border="0">
  ...
  <tr>
    ...
    <td><?php echo $Bullion->getUniqueCenturyCollectionCountById($userID, $century); ?> of <?php echo $coin->getCenturyCount($century); ?> (<?php echo percent($collection->getCenturyAllCollectionById($userID, $century), $coin->getCenturyCount($century)) ?>%)</td>
  </tr>
  </table>
  <br />
  <table border="0" id="folderTbl" class="typeTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="6"><h3>21st Century Gold Type Collection <?php echo $collection->getTypeCollectionProgressByID($userID) ?> of 9 (<?php echo percent($collection->getTypeCollectionProgressByID($userID), '9'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 

<td><a href="Gold_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
...
<td><a href="Three_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Three Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="Three_Dollar.php">Three Dollar</a> </td>
<td><a href="Four_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Four Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="Four_Dollar.php">Four Dollar</a></td>
<td><a href="Five_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Five Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
...
<td colspan="2"><a href="Twenty_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Twenty Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="Twenty_Dollar.php">Twenty Dollar</a></td>

<td colspan="2"><a href="Twenty_Five_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Twenty Five Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="Twenty_Five_Dollar.php">Twenty Five Dollar</a></td>
  
<td colspan="2"><a href="Fifty_Dollar.php"><img class="coinSwitch" src="../img/<?php echo $Bullion->getGoldCategoryImg('Fifty Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
...
<div class="roundedWhite">
 ...
 <tr>
  ...
  <tr>
    ...
    <td align="center" id="Union_ShieldCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $Bullion->getTotalCollectedCategoryByID('Three Dollar', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $Bullion->getGoldSumByCategoryByID('Three Dollar', $userID); ?>" /></td>
 </tr>
 
  <tr>
    <td><a href="Four_Dollar.php" class="brownLink">Four Dollars</a></td>
    <td align="center" id="WestwardJourneyCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $Bullion->getTotalCollectedCategoryByID('Four Dollar', $userID); ?>" /></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $Bullion->getGoldSumByCategoryByID('Four Dollar', $userID); ?>" /></td>
  </tr>
 <tr>
 ...
 <tr>
  ...
  <tr>
    ...
    <td align="center" id="Union_ShieldCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $Bullion->getTotalCollectedCategoryByID('Twenty Dollar', $userID); ?>"/ ></td>
    <td align="center"><input readonly class="valCount" type="text" value="<?php echo $Bullion->getGoldSumByCategoryByID('Twenty Dollar', $userID); ?>" /></td>
 </tr>
   <tr>
