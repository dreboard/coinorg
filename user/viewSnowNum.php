...
<title><?php echo str_replace('_', ' ', $_GET["coinYear"]); ?> <?php echo str_replace('_', ' ', $_GET["coinType"]); ?>  <?php echo str_replace('_', ' ', $_GET["snow"]); ?> List</title>
...
<h1><img src="../img/<?php echo $coinCatLink ?>.jpg" width="40" height="40" align="absmiddle" /> <?php echo str_replace('_', ' ', $_GET["coinYear"]); ?> <?php echo str_replace('_', ' ', $_GET["coinType"]); ?>  <?php echo str_replace('_', ' ', $_GET["snow"]); ?> List</h1>
...
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE coinType = '".str_replace('_', ' ', $_GET["coinType"])."' AND userID = '$userID' AND snow ='".str_replace('_', ' ', $_GET["snow"])."' AND coinYear = '".strip_tags($_GET["coinYear"])."' ORDER BY coinYear DESC") or die(mysql_error());
