...
header("location: viewTypeRollEdit.php?ID=".$Encryption->encode($collectrollsID)."");
}
...
<tr align="center" class="darker">
    <td width="25"><h3><a href="viewTypeRollDetail.php?ID=<?php echo $Encryption->encode($collectrollsID) ?>">Roll Main View</a></h3></td>
    <td width="25%"><h3><a href="editRollCoinType.php?ID=<?php echo $Encryption->encode($collectrollsID) ?>">Edit This Roll Details</a></h3></td>
    <td width="25%"><h3><a href="addRollSameType.php">Add Same Type Roll</a></h3></td>
...
<label for="collectionID"><strong><?php echo $collection->availableTypeCoinsRequest ($coinType, $userID); ?></strong> Available Coins In Collection </label>
...
<?php 
$sql  = mysql_query("SELECT * FROM collection WHERE coinType = '$coinType' AND proservice = 'None' AND collectfolderID = '0' AND collectrollsID = '0' AND collectsetID = '0' AND setregID = '0' AND userID = '$userID'");
...
<label for="collectionID"><?php echo $collection->availableTypeCoinsRequest ($coinType, $userID); ?> Available Coins In Collection </label>
...
<?php
$i = 1;
$result  = mysql_query("SELECT * FROM collection WHERE coinType = '$coinType' AND proservice = 'None' AND collectfolderID = '0' AND collectrollsID = '0' AND collectsetID = '0' AND setregID = '0' AND userID = '$userID'");
...
<?php 
    ...
    <td>'.$collectionRolls->otherTypeCoinsList(intval($row['collectionID']), $coinType, $userID, $collectrollsID).'</td>
