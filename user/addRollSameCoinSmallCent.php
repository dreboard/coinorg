...
<table width="100%" border="0" align="center" id="rawTypeTbl">
  <tr align="center">
    <td><a href="addRollSameCoinSmallCentForm.php?coinType=Flying_Eagle"><img src="../img/Flying_Eagle.jpg" alt="Flying_Eagle" name="Half_CentImg"  class="newImg" id="Half_CentImg" /></a></td>
