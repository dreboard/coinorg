...
<title><?php echo $coinMetal ?> Proof Coins</title>
...
<table width="100%" border="0">
  <tr>
    <td><h1><img src="../img/Eisenhower_Dollar_Proof.jpg" alt="" width="100" height="100" align="middle" /> <?php echo $coinMetal ?> Proof Coins</h1></td>
...
<thead class="darker">
  <tr>
    ...
    <td width="24%">Type</td>  
    <td width="11%" align="center">Grader</td>
    <td width="9%" align="right">Purchase</td>
  </tr>
</thead>
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE userID = '$userID' AND coinMetal = '$coinMetal' AND strike = 'Proof' ORDER BY coinID ASC") or die(mysql_error());
if(mysql_num_rows($countAll)== 0){
  ...
  echo '
	...
	<td align="center">'.$collection->getCoinGrade().'/'.$collection->getGrader().'</td>
