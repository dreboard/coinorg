...
<title>My Three Dollar Collection</title>
...
<h1><img src="../img/Indian_Princess_Three_Dollar.jpg" width="100" height="100" align="middle">My Three Dollar Collection</h1>
...
<br />
<table width="472" border="0" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="2"><h3>Three Dollar Type Collection</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  
<td><a href="viewCoinVersion.php?coinVersion=Indian_Princess_Three_Dollar"><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Indian_Princess_Three_Dollar', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCoinVersion.php?coinVersion=Indian_Princess_Three_Dollar">Indian Princess</a> </td>  
  
<td><a href="viewCoinVersion.php?coinVersion=Indian_Princess_Three_Dollar_Proof"><img class="coinSwitch" src="../img/<?php echo $collection->getVarietyImg('Indian_Princess_Three_Dollar_Proof', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewCoinVersion.php?coinVersion=Indian_Princess_Three_Dollar_Proof">Indian Princess Proof</a> </td>
...
<div>
  <table width="100%" class="reportList priceListTbl" border="1">
    ...
    <tr>
      <td><a href="viewListReport.php?coinType=Indian_Princess_Three_Dollar" class="brownLink">Indian Princess </a> (1854-1889)</td>
      <td align="center"><input readonly="readonly" class="collectCount3" type="text" value="<?php echo $collection->getReportTypeCount('Indian_Princess_Three_Dollar', $userID); ?>"></td>
      
      <td align="center"><input readonly="readonly" class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Indian_Princess_Three_Dollar', $userID)?>" /></td>
    </tr>
...
<a target="_blank" href="http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&icep_uq=&icep_sellerId=&icep_ex_kw=&icep_sortBy=12&icep_catId=39468&icep_minPrice=&icep_maxPrice=&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg"><img src="../img/ads/Three_Dollar_ebay_ad.jpg" width="900" height="100" border="0" /></a><img style="text-decoration:none;border:0;padding:0;margin:0;" src="http://rover.ebay.com/roverimp/1/711-53200-19255-0/1?ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&mpt=[CACHEBUSTER]"></p>
