...
<h1><img src="../img/Two_Cent_Proof.jpg" width="100" height="100" align="middle"> Two Cents</h1>
...
<table class="table coin-switch-tbl">
  ...
  <td><a href="viewListReport.php?coinType=Two_Cent_Piece"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Two Cent Piece', $userID); ?>" alt="" width="100" height="100" /></a><br />
    <a href="viewListReport.php?coinType=Two_Cent_Piece">Two Cent Piece</a></td>
</tr>
 </table>
</div>
 <div class="table-responsive">
<table class="table table-hover clearfix">
  ...
  <td><a href="viewListReport.php?coinType=Two_Cent_Piece" class="brownLink">Two Cent Piece</a> (1864-1873)</td>
  <td align="center" id="Flying_EagleCount"><?php echo $collection->getReportTypeCount('Two_Cent_Piece', $userID); ?></td>  
  <td align="center"><?php echo $collection->getSumTypeCount('Two_Cent_Piece', $userID)?></td>
  <tr>
 <tr class="active darker">
   <td>Totals</td>
