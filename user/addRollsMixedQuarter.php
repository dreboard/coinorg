...
$denomination = "0.250";
$coinCount = "40";
$coinCategory = str_replace('_', ' ', 'Quarter');

$coinQuery = mysql_query("SELECT * FROM coins WHERE coinCategory = 'Quarter'") or die(mysql_error());
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
    <td width="182" rowspan="5" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/Mixed_Quarters.jpg" width="100" height="auto" align="texttop" /></td>
