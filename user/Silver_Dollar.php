...
<div class="container fill-height">
 <h1><img src="../img/Silver_Dollar.jpg" width="100" height="100" align="middle"> Silver Dollars</h1>
...
<td><a href="viewListReport.php?coinType=Silver_American_Eagle"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Silver_American_Eagle', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <span><a class="brownLink" href="viewListReport.php?coinType=Silver_American_Eagle">Silver American Eagle</a></span></td>  
</tr>
 </table>
</div>
 <div class="table-responsive">
<table class="table table-hover clearfix">
    ...
    <tr>
      <td width="444" class="darker">Silver Types</td>
      ...
      <tr>
        ...
        <td align="center"><?php echo $collection->getReportTypeCount('Silver_American_Eagle', $userID); ?></td>
        <td align="center"><?php echo $collection->getSumTypeCount('Silver_American_Eagle', $userID)?></td>
      </tr>
