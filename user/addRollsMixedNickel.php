...
$denomination = "0.050";
$coinCount = "40";
$coinCategory = str_replace('_', ' ', 'Nickel');

$coinQuery = mysql_query("SELECT * FROM coins WHERE coinCategory = 'Nickel'") or die(mysql_error());
...
mysql_query("INSERT INTO collectrolls(coinType, coinCategory, coinSubCategory, coinGrade, purchaseDate, purchaseFrom, auctionNumber, additional, purchasePrice, ebaySellerID, shopName, shopUrl, coinNote, enterDate, userID, rollType, coinCount, coinCategory) VALUES('$coinType', '$coinCategory', '$coinSubCategory', '$coinGrade', '$purchaseDate', '$purchaseFrom', '$auctionNumber', '$additional', '$purchasePrice', '$ebaySellerID', '$shopName', '$shopUrl', '$coinNote', '$theDate', '$userID', 'Mixed','$coinCount', '$coinCategory')") or die(mysql_error()); 
...
<h1>Add Mixed <?php echo $coinCategory ?> Roll</h1>
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
    <td width="182" rowspan="5" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/Mixed_Nickels.jpg" width="100" height="auto" align="texttop" /></td>
    <td width="204" valign="top" class="darker" id="rollTypeLbl">Coin Types</td>
    <td colspan="4">
   <?php 
   $getTypes = mysql_query("SELECT DISTINCT coinType FROM coins WHERE coinCategory = '$coinCategory'") or die(mysql_error());
