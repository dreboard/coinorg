...
<title><?php echo $coinType ?> Proof Rolls</title>
...
<table width="100%" border="0">
  <tr>
    <td><h1><img src="../img/<?php echo $coinCatLink ?>.jpg" width="100" height="100" align="middle"> <?php echo $coinType ?>  Rolls (<?php echo $collectionRolls->getRollCountByType($userID, $coinType); ?>)</h1></td>
