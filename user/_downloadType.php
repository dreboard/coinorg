...
//PROCESS COLLECTION	
$getCoins = mysql_query("SELECT coinID, purchasePrice, purchaseDate FROM collection WHERE coinType = '".str_replace('_', ' ', $_GET['coinType'])."' AND userID = '$userID' ") or die(mysql_error());
...
header("Content-Disposition: attachment; filename=My_".$_GET['coinType']."_Collection.xls"); 
