...
<title>My Fifty Dollar Collection</title>
...
<h1><img src="../img/Gold_American_Eagle_Proof.jpg" width="100" height="100" align="middle"> My Fifty Dollar Collection (<?php echo $collection->getCompleteCollectionCategoryById($userID, $coinCategory); ?>) Coins</h1>
...
<table width="100%" class="reportListTbl" border="0">
  <tr>
    ...
    <td width="65%"><?php echo $collection->getTotalCollectedCoinsByID($coinCategory, $userID); ?> (<?php echo $collection->getUniqueCollectionCountByCategory($userID, $coinCategory) ?> Unique)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>$<?php echo$collection->getTotalFaceValSumByCategory($coinCategory, $userID); ?></td>
  </tr>
  <tr>
...
<br />
<table width="644" border="0" class="typeTbl" id="folderTbl">
  <tr class="dateHolder" valign="top">
    <td colspan="3"><h3>Fifty Dollar Type Collection <?php echo $collection->getTypeCollectionProgressByCategory($coinCategory, $userID) ?> of 3 (<?php echo percent($collection->getTypeCollectionProgressByCategory($coinCategory, $userID), '3'); ?>%)</h3></td>
    </tr>
  <tr class="dateHolder" valign="top"> 
  <td><a href="viewListReport.php?coinType=Half_Ounce_Platinum"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('Half_Ounce_Platinum', $userID); ?>" alt="" width="100" height="100" /></a><br />
    <a href="viewListReport.php?coinType=Half_Ounce_Platinum">Half Ounce Platinum</a></td>
  ...
  <td><a href="viewListReport.php?coinType=One_Ounce_Buffalo"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('One_Ounce_Buffalo', $userID); ?>" alt="" width="100" height="100" /></a><br />
    <a href="viewListReport.php?coinType=One_Ounce_Buffalo">American Buffalo</a> </td>
...
<td><a href="viewListReport.php?coinType=One_Ounce_Gold"><img class="coinSwitch" src="../img/<?php echo $collection->getReportImage('One_Ounce_Gold', $userID); ?>" alt="" width="100" height="100" /></a><br />
  <a href="viewListReport.php?coinType=One_Ounce_Gold">American Eagle</a></td>
</tr>
 </table>
<br />
...
<div>
  ...
  <tr>
  <td><a href="viewListReport.php?coinType=Half_Ounce_Platinum" class="brownLink">Half Ounce Platinum</a> (1997-Present)</td>
  <td align="center" id="Flying_EagleCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('Half_Ounce_Platinum', $userID); ?>"/ ></td>  
  <td align="center"><input readonly class="valCount" type="text" value="<?php echo $collection->getSumTypeCount('Half_Ounce_Platinum', $userID)?>" /></td>

  <tr>
    <td><a href="viewListReport.php?coinType=One_Ounce_Buffalo" class="brownLink">American Buffalo</a> (2008-Present)</td>
     <td align="center" id="Indian_HeadCount"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('One_Ounce_Buffalo', $userID); ?>"/ ></td>  
 ...
 <tr>
    <td><a href="viewListReport.php?coinType=One_Ounce_Gold" class="brownLink"> American Eagle</a> (1986-Present)
    <td align="center"><input readonly class="smallCentCollectCount" type="text" value="<?php echo $collection->getReportTypeCount('One_Ounce_Gold', $userID); ?>"/ ></td>
 ...
 <tr class="noHighlight">
   <td>Totals</td>
   <td align="center"><input id="smallCentCollectTotals" readonly class="collectCountTotal" type="text" value="<?php echo $collection->getTotalCollectedCoinsByID($coinCategory, $userID); ?>" /></td>
   <td align="center"><input id="valTotals" readonly class="collectCount" type="text" value="<?php echo $collection->getTotalInvestmentSumByCategory($coinCategory, $userID); ?>" /></td>
 </tr>
</table>
<br />
...
<a target="_blank" href="http://rover.ebay.com/rover/1/711-53200-19255-0/1?icep_ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&icep_uq=one+oz+Gold+American+Eagle&icep_sellerId=&icep_ex_kw=&icep_sortBy=12&icep_catId=39482&icep_minPrice=&icep_maxPrice=&ipn=psmain&icep_vectorid=229466&kwid=902099&mtid=824&kw=lg"><img src="../img/ads/Twenty_Five_Dollar_ebay_ad.jpg" width="900" height="100" border="0" /></a><img style="text-decoration:none;border:0;padding:0;margin:0;" src="http://rover.ebay.com/roverimp/1/711-53200-19255-0/1?ff3=9&pub=5575051408&toolid=10001&campid=5337366073&customid=&uq=one+oz+Gold+American+Eagle&mpt=[CACHEBUSTER]"></p>
<p><a class="brownLinkBold" href="#top">Top</a></p>
</div>
