...
<title><?php echo $proService ?> <?php echo $coinMetal ?> Proof Coins</title>
...
<table width="100%" border="0">
  <tr>
    <td><h1><img src="../img/Eisenhower_Dollar_Proof.jpg" alt="" width="100" height="100" align="middle" /> <?php echo $proService ?> <?php echo $coinMetal ?> Proof Coins</h1></td>
...
<table width="100%" id="reportListLinks" class="clear">
  <tr>
     <td width="33%" class="darker"><a href="proof.php">All Proofs</a></td>
...
<thead class="darker">
  <tr>
    ...
    <td width="22%">Type</td>  
    <td width="7%" align="center">Grade</td>
    <td width="9%" align="right">Purchase</td>
  </tr>
</thead>
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE userID = '$userID' AND proService = '$proService' AND coinMetal = '$coinMetal' AND strike = 'Proof' ORDER BY coinID ASC") or die(mysql_error());
