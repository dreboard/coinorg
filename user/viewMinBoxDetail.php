...
<td width="149" class="tdHeight"><span class="darker">Box Type: </span></td>
<td width="622" class="tdHeight"><a href="viewMintBox.php?boxMintID=<?php echo $CollectionBoxes->getBoxMintID() ?>"><?php echo $CollectionBoxes->getBoxType(); ?></a></td>
<td width="18"></td>
</tr>
<tr>
