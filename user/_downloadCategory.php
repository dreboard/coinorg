...
//PROCESS COLLECTION	
$getCoins = mysql_query("SELECT coinID, purchasePrice, purchaseDate FROM collection WHERE coinCategory = '".str_replace('_', ' ', $_GET['category'])."' AND userID = '$userID' ") or die(mysql_error());
...
header("Content-Disposition: attachment; filename=My_".$_GET['category']."_Collection.xls"); 
