...
<div class="table-responsive">
  ...
  <tr>
    <td><a href="viewFolderCollection.php" class="btn btn-default btn-lg btn-block">Folders Views</a></td>
    <td><a href="errors.php" class="btn btn-default btn-lg btn-block">Common Errors</a></td>
    <td height="30">&nbsp;</td>
    <td><a href="certList.php" class="btn btn-default btn-lg btn-block">To Be Certified</a></td>
    </tr>
</table>
</div>
