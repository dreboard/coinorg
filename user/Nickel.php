...
<title>My Nickel Collection</title>
...
<div class="container fill-height">
 <h1><img src="../img/Mixed_Nickels.jpg" width="100" height="100" align="middle">Nickels</h1>
...
<table class="table coin-switch-tbl">
  <tr align="center"  valign="top" class="setSixRow">
    <td><a href="viewListReportBOOTS.php?coinType=Shield_Nickel"> <img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Shield Nickel', $userID); ?>"  /></a></td>
    <td><a href="viewListReport.php?coinType=Liberty_Head_Nickel"> <img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Liberty Head Nickel', $userID); ?>"  /></a></td>
    <td><a href="viewListReport.php?coinType=Indian_Head_Nickel"><img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Indian Head Nickel', $userID); ?>"  /></a></td>
    <td><a href="viewListReport.php?coinType=Jefferson_Nickel"><img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Jefferson Nickel', $userID); ?>"  /></a></td>
    <td><a href="viewListReport.php?coinType=Westward_Journey"><img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Westward Journey', $userID); ?>"  /></a></td>
    <td><a href="viewListReport.php?coinType=Return_to_Monticello"><img class="img-responsive2" src="../img/<?php echo $collection->getReportImage('Return to Monticello', $userID); ?>"  /></a></td>
  </tr>
  <tr align="center"  valign="top" class="getCoinImgRow">
    <td><a href="viewListReport.php?coinType=Shield_Nickel">Shield</a></td>
    <td><a href="viewListReport.php?coinType=Liberty_Head_Nickel">Liberty Head</a></td>
    <td><a href="viewListReport.php?coinType=Indian_Head_Nickel">Indian Head</a></td>
    <td><a href="viewListReport.php?coinType=Jefferson_Nickel">Jefferson</a></td>
    <td><a href="viewListReport.php?coinType=Westward_Journey">Westward Journey</a></td>
    <td><a href="viewListReport.php?coinType=Return_to_Monticello">Return to Monticello</a></td>
  </tr>
 </table>  
</div>
 <div class="table-responsive">
<table class="table table-hover clearfix">
     <tr class="active darker">
      <td width="444" class="darker"><strong>Types</strong></td>
      <td width="210" align="center" class="darker"><strong>Collected Pieces</strong></td>    
      <td width="228" align="center" class="darker"> <strong>Investment</strong></td>
    </tr>
  
    <tr>
      <td><a href="viewListReport.php?coinType=Shield_Nickel" class="brownLink">Shield Nickel </a>(1866-1883)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Shield Nickel', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Shield Nickel', $userID)?></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Liberty_Head_Nickel" class="brownLink">Liberty Head</a> (1883-1913)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Liberty Head Nickel', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Liberty Head Nickel', $userID)?></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Indian_Head_Nickel" class="brownLink">Indian Head </a> (1913-1938) </td>
      <td align="center"><?php echo $collection->getReportTypeCount('Indian Head Nickel', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Indian Head Nickel', $userID)?></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Jefferson_Nickel" class="brownLink">Jefferson Nickel</a> (1938-2003)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Jefferson Nickel', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Jefferson Nickel', $userID)?></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Westward_Journey" class="brownLink">Westward Journey</a> (2004-2005)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Westward Journey', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Westward Journey', $userID)?></td>
    </tr>
    <tr>
      <td><a href="viewListReport.php?coinType=Return_to_Monticello" class="brownLink">Return to Monticello</a> (2006-Present)</td>
      <td align="center"><?php echo $collection->getReportTypeCount('Return to Monticello', $userID); ?></td>
      <td align="center"><?php echo $collection->getSumTypeCount('Return to Monticello', $userID)?></td>
    </tr>
  

 <tr class="active darker">
   <td><strong>Totals</strong></td>
   <td align="center"><strong><?php echo $collectTotal; ?></strong></td>
   <td align="center"><strong><?php echo $collection->getMasterCoinSumByCoinCategory($coinCategory, $userID); ?></strong></td>
 </tr>
</table>
</div>
