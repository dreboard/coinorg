...
if ( !file_exists($userID.'/firstday/'.$collectfirstdayID) ) {
    mkdir($userID.'/firstday/'.$collectfirstdayID, 0755, true);
}
...
$Upload->SetUploadDirectory($userID.'/firstday/'.$collectfirstdayID."/");
$Upload->SetValidExtensions(array('gif', 'jpg', 'jpeg', 'png')); 
$Upload->SetMaximumFileSize(3000000); 
$Upload->UploadFile();
$coinPic1 = $userID.'/firstday/'.$collectfirstdayID."/" . $_FILES['file']['name'];
$fileQuery = mysql_query("UPDATE collectfirstday SET coinPic1 = '$coinPic1' WHERE collectfirstdayID = '$collectfirstdayID'")  or die(mysql_error()); 
}
...
<img src="../img/firstdaySlabs.jpg" alt="" width="170" height="114" align="left" /><span class="errorTxt" id="errorMsg"><?php echo $errorMsg; ?></span>
<form action="" method="post" enctype="multipart/form-data" name="addCentForm" id="addCentForm" class="clear">
...
$query = mysql_query("SELECT * FROM firstday") or die(mysql_error());
 ...
 ?>
  ...
  <tr>
    ...
    <td colspan="4"><select name="coinDesignation" id="coinDesignation">
<option value="None" selected="selected">None</option>
