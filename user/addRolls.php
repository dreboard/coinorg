...
if($_POST['proService'] == 'None') {
	...
	$proSerialNumber = insertNone($_POST["proSerialNumber"]);
    $slabLabel = insertNone($_POST["slabLabel"]);
}
...
mysql_query("INSERT INTO collection(coinID, coinType, coinCategory, coinSubCategory, proService, proSerialNumber, slabLabel, coinGrade, purchaseDate, purchaseFrom, auctionNumber, additional, purchasePrice, ebaySellerID, shopName, shopUrl, coinNote, enterDate, accountID, errorType, byMint) VALUES('$coinID', '$coinType', '$coinCategory', '$coinSubCategory', '$proService', '$proSerialNumber', '$slabLabel', '$coinGrade', '$purchaseDate', '$purchaseFrom', '$auctionNumber', '$additional', '$purchasePrice', '$ebaySellerID', '$shopName', '$shopUrl', '$coinNote', '$theDate', '$accountID', '$errorType', '$byMint')") or die(mysql_error()); 
...
<h1>Add Roll By Denomination</h1>
...
<div class="roundedWhite">
  ...
  <table width="980" border="0" class="priceListTbl">
  <tr>
    <td width="187" rowspan="6" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/newMyRoll.jpg" width="100" height="auto" align="texttop" /></td>
...
?>
  ...
  <tr>
    ...
    <td colspan="4"><input type="text" name="purchaseDate3" id="purchaseDate3" class="purchaseDate" /></td>
  </tr>
  <tr>
...
<table width="84%" border="0">
  ...
  <tr>
    <td width="187" rowspan="4" valign="top" class="darker"><img src="../img/blank2.jpg" alt="" width="90" height="90" id="typeImage" /></td>
  ...
  <tr>
    ...
    <td colspan="4"><label for="additional"></label>
      <textarea name="additional" id="additional" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
