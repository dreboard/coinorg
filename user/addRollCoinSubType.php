...
$coinSubCategory = strip_tags($_GET["coinSubCategory"]);
...
$coinCount = $rolls->getRollCountByType($coinCategory);
$denomination = $rolls->getRollDeniminationByType($coinCategory);
$mintMark = getMintMark($coinID);
...
mysql_query("INSERT INTO collectrolls(coinID, coinType, coinCategory, coinSubCategory, coinGrade, mintMark, purchaseDate, purchaseFrom, auctionNumber, additional, purchasePrice, ebaySellerID, shopName, shopUrl, coinNote, enterDate, accountID, rollType) VALUES('$coinID', '$coinType', '$coinCategory', '$coinSubCategory', '$coinGrade', '$mintMark', '$purchaseDate', '$purchaseFrom', '$auctionNumber', '$additional', '$purchasePrice', '$ebaySellerID', '$shopName', '$shopUrl', '$coinNote', '$theDate', '$accountID', 'Same Year')") or die(mysql_error()); 
...
<h1>Add  <?php echo $coinTypeSearch ?> Roll (Mixed Types)</h1>
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
    <td width="182" rowspan="6" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/<?php echo $coinSubCategory ?>.jpg" width="100" height="auto" align="texttop" /></td>
      </tr>
  <tr>
    <td width="226" valign="top" class="darker" id="rollTypeLbl2">Mint Marks</td>
  ...
  <tr>
    <td class="darker"><strong>Grades</strong></td>
    <td colspan="4"><strong>
  ...
  <tr>
    ...
    <td width="166"><input type="radio" name="purchaseFrom" value="Coin Shop" id="shopRad" />
<label for="shopRad">Coin Shop</label></td>
    <td width="103"><input type="radio" name="purchaseFrom" value="Other" id="otherRad" />
      <label for="otherRad">Other</label></td>
    <td width="170"><input name="purchaseFrom" type="radio" id="noneRad" value="None" checked="checked" />
      <label for="noneRad">None</label></td>
  </tr>
  <tr>
    <td colspan="6" valign="top" class="darker">
