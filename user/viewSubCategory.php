...
$coinSubCategory = str_replace('_', ' ', $_GET["coinSubCategory"]);
$coinTypeLink = $_GET["coinSubCategory"];


$coinCatLink = str_replace(' ', '_', $_GET["coinSubCategory"]);
...
<title><?php echo $coinSubCategory ?>  Report</title>
...
<style type="text/css">
.coinSubCategoryImg {width:150px; height:150px;}
</style>
...
<h2><img src="../img/<?php echo $coinCatLink ?>.jpg" width="150" height="150" align="absmiddle" class="coinSubCategoryImg" title="<?php echo $coinType ?>" />&nbsp;&nbsp;<?php echo $coinSubCategory ?>  Report</h2>
<table width="100%" border="0" class="reportListTbl">  
  ...
  <tr>
    <td width="31%">Total Collected</td>
    <td width="69%"><?php echo $collection->getCollectionCountByType($userID, $coinType) ?></td>
  </tr>
  <tr>
    <td>Total Unique</td>
  ...
  <tr>
    ...
    <form action="reportPrintType.php" method="post" class="compactForm">
<input name="coinType" type="hidden" value="<?php echo $coinType ?>" />
<input class="masterBtn" id="printBtn" type="submit" value="Print Report"/ ></form></td>
    <td valign="top">&nbsp;</td>
  </tr>
</table>
<br />
  ...
  <tr valign="top" class="darker">
    ...
    <td width="243" align="center" valign="middle"><select id="typeChanger" name="select" onchange="window.open(this.options[this.selectedIndex].value,'_top')">
      ...
      <optgroup label="Two Cents">
        <option value="viewListReport.php?coinType=Two_Cent_Piece">Two Cent Piece</option>
        </optgroup>
      ...
      <optgroup label="Nickels">
        <option value="viewListReport.php?coinType=Shield_Nickel">Shield</option>
      ...
      <optgroup label="Dimes">
        <option value="viewListReport.php?coinType=Draped_Bust_Dime">Drapped Bust Dime</option>
  ...
  <tr valign="top" class="darker">
    ...
    <td valign="middle"><a href="viewBagReport.php?coinType=<?php echo $coinCatLink ?>"> Bags</a></td>
...
<?php
$countAll = mysql_query("SELECT DISTINCT coinID FROM collection WHERE coinSubCategory = '$coinSubCategory' AND userID = '$userID' ORDER BY coinID ASC") or die(mysql_error());
