...
$coinSubCategory = str_replace('_', ' ', mysql_real_escape_string($_GET["coinSubCategory"]));
$rawcoinCategory = strip_tags($_GET["coinSubCategory"]);
...
<h1>Add Mixed <?php echo $coinSubCategory ?> Roll</h1>
...
<table width="100%" border="0" class="priceListTbl">
  <tr>
    <td width="182" rowspan="5" valign="top" class="darker"><h2 class="rollHdr">Type Roll</h2>
      <img src="../img/<?php echo $rawcoinCategory ?>.jpg" width="100" height="auto" align="texttop" /></td>
    <td width="204" valign="top" class="darker" id="rollTypeLbl">Coin Types</td>
    <td colspan="4">
   <?php 
   $getTypes = mysql_query("SELECT DISTINCT coinType FROM coins WHERE coinSubCategory = '$coinSubCategory'") or die(mysql_error());
