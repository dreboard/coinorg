...
<h1>My <a href="viewGradeReport.php?coinType=<?php echo $categoryLink ?>"><?php echo $coinName ?>'s</a> Graded <?php echo $coinGrade ?></h1>
...
<thead>
  ...
  <tbody>
<?php
$countAll = mysql_query("SELECT * FROM collection WHERE coinID = '$coinID' AND proService = 'None' AND coinGrade = '$coinGrade' AND userID = '$userID' ORDER BY coinID ASC") or die(mysql_error());
