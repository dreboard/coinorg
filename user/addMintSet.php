...
<div id="content" class="clear">
  <h1><img src="../img/Mintset.jpg" width="100" height="100" align="absmiddle"> Add U.S. Mint Coin Set</h1>
...
<?php 
$collectionQuery = mysql_query("SELECT * FROM collectset WHERE userID = '$userID' AND setVersion = 'Mint' ORDER BY collectsetID DESC LIMIT 5") or die(mysql_error());
...
<form action="" method="post" enctype="multipart/form-data" name="addCentForm" id="addCentForm">
  ...
  <tr>
    <td width="216"><label for="mintsetID">Set Type</label></td>
    <td colspan="4">
    <select name="mintsetID" id="mintsetID">
    <option value="" selected="selected">Select A Coin Set</option>
<?php    
$query = mysql_query("SELECT * FROM mintset WHERE coinYear <= ".date('Y')." ORDER BY coinYear ASC") or die(mysql_error());
